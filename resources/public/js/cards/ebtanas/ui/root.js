...
var x50075_50087 = ebtanas.ui.root.Root.prototype;
x50075_50087.componentWillUpdate = ((function (x50075_50087){
...
var ident__41275__auto___50088 = om.next.ident.call(null,this__41271__auto__,om.next.props.call(null,this__41271__auto__));
var next_ident__41276__auto___50089 = om.next.ident.call(null,this__41271__auto__,om.next._next_props.call(null,next_props__41272__auto__,this__41271__auto__));
if(cljs.core.not_EQ_.call(null,ident__41275__auto___50088,next_ident__41276__auto___50089)){
var idxr__41277__auto___50090 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__41271__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__41277__auto___50090 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__41277__auto___50090),((function (idxr__41277__auto___50090,ident__41275__auto___50088,next_ident__41276__auto___50089,this__41271__auto__,x50075_50087){
return (function (indexes__41278__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__41278__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__41275__auto___50088], null),cljs.core.disj,this__41271__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__41276__auto___50089], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__41271__auto__);
});})(idxr__41277__auto___50090,ident__41275__auto___50088,next_ident__41276__auto___50089,this__41271__auto__,x50075_50087))
);
}
} else {
}
...
x50075_50087.shouldComponentUpdate = ((function (x50075_50087){
return (function (next_props__41272__auto__,next_state__41273__auto__){
var this__41271__auto__ = this;
...
var next_props__41272__auto____$2 = (function (){var G__50077 = next_props__41272__auto____$1;
if((next_props__41272__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__50077);
} else {
return G__50077;
}
})();
...
x50075_50087.componentWillUnmount = ((function (x50075_50087){
return (function (){
var this__41271__auto__ = this;
...
x50075_50087.componentDidUpdate = ((function (x50075_50087){
...
x50075_50087.isMounted = ((function (x50075_50087){
return (function (){
var this__41271__auto__ = this;
...
x50075_50087.componentWillMount = ((function (x50075_50087){
return (function (){
var this__41271__auto__ = this;
...
x50075_50087.render = ((function (x50075_50087){
return (function (){
var this__41270__auto__ = this;
var this$ = this__41270__auto__;
var _STAR_reconciler_STAR_50078 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_50079 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_50080 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_50081 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_50082 = om.next._STAR_parent_STAR_;
...
try{var map__50083 = om.next.props.call(null,this$);
...
var a = cljs.core.get.call(null,map__50083__$1,new cljs.core.Keyword(null,"a","a",-2123407586));
return om.dom.h1.call(null,null,a);
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_50082;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_50081;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_50080;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_50079;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_50078;
}});})(x50075_50087))
;
...
var x50085_50091 = ebtanas.ui.root.Root;
/** @nocollapse */
x50085_50091.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x50085_50091.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x50085_50091){
...
/** @nocollapse */
x50085_50091.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x50085_50091.om$next$IQuery$query$arity$1 = ((function (x50085_50091){
...
var x50086_50092 = ebtanas.ui.root.Root.prototype;

x50086_50092.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;


x50086_50092.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x50086_50092){
return (function (this$,params){
var this$__$1 = this;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"a","a",-2123407586),(1)], null);
});})(x50086_50092))
...
x50086_50092.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;


x50086_50092.om$next$IQuery$query$arity$1 = ((function (x50086_50092){
return (function (this$){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586)], null);
});})(x50086_50092))
...
//# sourceMappingURL=root.js.map?rel=1491695665995