...
var x50051_50063 = ebtanas.ui.main.MainPage.prototype;
x50051_50063.componentWillUpdate = ((function (x50051_50063){
...
var ident__41275__auto___50064 = om.next.ident.call(null,this__41271__auto__,om.next.props.call(null,this__41271__auto__));
var next_ident__41276__auto___50065 = om.next.ident.call(null,this__41271__auto__,om.next._next_props.call(null,next_props__41272__auto__,this__41271__auto__));
if(cljs.core.not_EQ_.call(null,ident__41275__auto___50064,next_ident__41276__auto___50065)){
var idxr__41277__auto___50066 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__41271__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__41277__auto___50066 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__41277__auto___50066),((function (idxr__41277__auto___50066,ident__41275__auto___50064,next_ident__41276__auto___50065,this__41271__auto__,x50051_50063){
return (function (indexes__41278__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__41278__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__41275__auto___50064], null),cljs.core.disj,this__41271__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__41276__auto___50065], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__41271__auto__);
});})(idxr__41277__auto___50066,ident__41275__auto___50064,next_ident__41276__auto___50065,this__41271__auto__,x50051_50063))
);
}
} else {
}
...
x50051_50063.shouldComponentUpdate = ((function (x50051_50063){
return (function (next_props__41272__auto__,next_state__41273__auto__){
var this__41271__auto__ = this;
...
var next_props__41272__auto____$2 = (function (){var G__50053 = next_props__41272__auto____$1;
if((next_props__41272__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__50053);
} else {
return G__50053;
}
})();
...
x50051_50063.componentWillUnmount = ((function (x50051_50063){
return (function (){
var this__41271__auto__ = this;
...
x50051_50063.componentDidUpdate = ((function (x50051_50063){
...
x50051_50063.isMounted = ((function (x50051_50063){
return (function (){
var this__41271__auto__ = this;
...
x50051_50063.componentWillMount = ((function (x50051_50063){
return (function (){
var this__41271__auto__ = this;
...
x50051_50063.render = ((function (x50051_50063){
return (function (){
var this__41270__auto__ = this;
var this$ = this__41270__auto__;
var _STAR_reconciler_STAR_50054 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_50055 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_50056 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_50057 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_50058 = om.next._STAR_parent_STAR_;
...
try{var map__50059 = om.next.props.call(null,this$);
var map__50059__$1 = ((((!((map__50059 == null)))?((((map__50059.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50059.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50059):map__50059);
var current_user = cljs.core.get.call(null,map__50059__$1,new cljs.core.Keyword(null,"current-user","current-user",-868792091));
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_50058;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_50057;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_50056;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_50055;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_50054;
}});})(x50051_50063))
;
...
var x50061_50067 = ebtanas.ui.main.MainPage;
/** @nocollapse */
x50061_50067.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x50061_50067.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x50061_50067){
...
/** @nocollapse */
x50061_50067.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x50061_50067.om$next$IQuery$query$arity$1 = ((function (x50061_50067){
...
/** @nocollapse */
x50061_50067.om_css$core$CSS$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x50061_50067.om_css$core$CSS$css$arity$1 = ((function (x50061_50067){
return (function (this$){
var this$__$1 = this;
...
/** @nocollapse */
x50061_50067.om$next$Ident$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x50061_50067.om$next$Ident$ident$arity$2 = ((function (x50061_50067){
...
var x50062_50068 = ebtanas.ui.main.MainPage.prototype;

x50062_50068.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;


x50062_50068.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x50062_50068){
return (function (this$,params){
var this$__$1 = this;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"main","main",-2117802661)], null);
});})(x50062_50068))
...
x50062_50068.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;


x50062_50068.om$next$IQuery$query$arity$1 = ((function (x50062_50068){
return (function (this$){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"current-user","current-user",-868792091),new cljs.core.Symbol(null,"_","_",-1201019570,null)], null)], null);
});})(x50062_50068))
...
x50062_50068.om_css$core$CSS$ = cljs.core.PROTOCOL_SENTINEL;


x50062_50068.om_css$core$CSS$css$arity$1 = ((function (x50062_50068){
return (function (this$){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_css.core.local_kw.call(null,ebtanas.ui.main.MainPage,new cljs.core.Keyword(null,"x","x",2099068185))], null)], null);
});})(x50062_50068))
...
x50062_50068.om$next$Ident$ = cljs.core.PROTOCOL_SENTINEL;


x50062_50068.om$next$Ident$ident$arity$2 = ((function (x50062_50068){
return (function (this$,props){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"main","main",-2117802661),new cljs.core.Keyword(null,"page","page",849072397)], null);
});})(x50062_50068))
...
//# sourceMappingURL=main.js.map?rel=1491695665882