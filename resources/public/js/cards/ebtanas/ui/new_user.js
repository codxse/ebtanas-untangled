...
var x49979_49996 = ebtanas.ui.new_user.NewUser.prototype;
x49979_49996.componentWillUpdate = ((function (x49979_49996){
...
var ident__41275__auto___49997 = om.next.ident.call(null,this__41271__auto__,om.next.props.call(null,this__41271__auto__));
var next_ident__41276__auto___49998 = om.next.ident.call(null,this__41271__auto__,om.next._next_props.call(null,next_props__41272__auto__,this__41271__auto__));
if(cljs.core.not_EQ_.call(null,ident__41275__auto___49997,next_ident__41276__auto___49998)){
var idxr__41277__auto___49999 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__41271__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__41277__auto___49999 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__41277__auto___49999),((function (idxr__41277__auto___49999,ident__41275__auto___49997,next_ident__41276__auto___49998,this__41271__auto__,x49979_49996){
return (function (indexes__41278__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__41278__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__41275__auto___49997], null),cljs.core.disj,this__41271__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__41276__auto___49998], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__41271__auto__);
});})(idxr__41277__auto___49999,ident__41275__auto___49997,next_ident__41276__auto___49998,this__41271__auto__,x49979_49996))
);
}
} else {
}
...
x49979_49996.shouldComponentUpdate = ((function (x49979_49996){
return (function (next_props__41272__auto__,next_state__41273__auto__){
var this__41271__auto__ = this;
...
var next_props__41272__auto____$2 = (function (){var G__49981 = next_props__41272__auto____$1;
if((next_props__41272__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__49981);
} else {
return G__49981;
}
})();
...
x49979_49996.componentWillUnmount = ((function (x49979_49996){
return (function (){
var this__41271__auto__ = this;
...
x49979_49996.componentDidUpdate = ((function (x49979_49996){
...
x49979_49996.isMounted = ((function (x49979_49996){
return (function (){
var this__41271__auto__ = this;
...
x49979_49996.componentWillMount = ((function (x49979_49996){
return (function (){
var this__41271__auto__ = this;
...
x49979_49996.render = ((function (x49979_49996){
return (function (){
var this__41270__auto__ = this;
var this$ = this__41270__auto__;
var _STAR_reconciler_STAR_49982 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_49983 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_49984 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_49985 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_49986 = om.next._STAR_parent_STAR_;
...
try{var map__49992 = om.next.props.call(null,this$);
...
var username = cljs.core.get.call(null,map__49992__$1,new cljs.core.Keyword("ui","username","ui/username",1605670678));
var password = cljs.core.get.call(null,map__49992__$1,new cljs.core.Keyword("ui","password","ui/password",417022099));
var password2 = cljs.core.get.call(null,map__49992__$1,new cljs.core.Keyword("ui","password2","ui/password2",557832013));
return om.dom.div.call(null,null,om.dom.div.call(null,({"className": "row"}),om.dom.div.call(null,({"className": "col-xs-4"}),""),om.dom.div.call(null,cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"className","className",-1983287057),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(om_css.core.local_class.call(null,ebtanas.ui.new_user.NewUser,"form")),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.str.cljs$core$IFn$_invoke$arity$1("col-xs-4"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" ")].join('')], null)),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "username"}),"Email Address"),om.dom.input.call(null,({"className": "form-control", "type": "email", "name": "username", "value": username, "onChange": ((function (map__49992,map__49992__$1,username,password,password2,_STAR_reconciler_STAR_49982,_STAR_depth_STAR_49983,_STAR_shared_STAR_49984,_STAR_instrument_STAR_49985,_STAR_parent_STAR_49986,this$,this__41270__auto__,x49979_49996){
return (function (p1__49972_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","username","ui/username",1605670678),new cljs.core.Keyword(null,"event","event",301435442),p1__49972_SHARP_);
});})(map__49992,map__49992__$1,username,password,password2,_STAR_reconciler_STAR_49982,_STAR_depth_STAR_49983,_STAR_shared_STAR_49984,_STAR_instrument_STAR_49985,_STAR_parent_STAR_49986,this$,this__41270__auto__,x49979_49996))
}))),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "password"}),"Password"),om.dom.input.call(null,({"name": "password", "className": "form-control", "type": "password", "value": password, "onChange": ((function (map__49992,map__49992__$1,username,password,password2,_STAR_reconciler_STAR_49982,_STAR_depth_STAR_49983,_STAR_shared_STAR_49984,_STAR_instrument_STAR_49985,_STAR_parent_STAR_49986,this$,this__41270__auto__,x49979_49996){
return (function (p1__49973_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","password","ui/password",417022099),new cljs.core.Keyword(null,"event","event",301435442),p1__49973_SHARP_);
});})(map__49992,map__49992__$1,username,password,password2,_STAR_reconciler_STAR_49982,_STAR_depth_STAR_49983,_STAR_shared_STAR_49984,_STAR_instrument_STAR_49985,_STAR_parent_STAR_49986,this$,this__41270__auto__,x49979_49996))
}))),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "password2"}),"Verify your Password"),om.dom.input.call(null,({"name": "password2", "className": "form-control", "type": "password", "value": password2, "onChange": ((function (map__49992,map__49992__$1,username,password,password2,_STAR_reconciler_STAR_49982,_STAR_depth_STAR_49983,_STAR_shared_STAR_49984,_STAR_instrument_STAR_49985,_STAR_parent_STAR_49986,this$,this__41270__auto__,x49979_49996){
return (function (p1__49974_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","password2","ui/password2",557832013),new cljs.core.Keyword(null,"event","event",301435442),p1__49974_SHARP_);
});})(map__49992,map__49992__$1,username,password,password2,_STAR_reconciler_STAR_49982,_STAR_depth_STAR_49983,_STAR_shared_STAR_49984,_STAR_instrument_STAR_49985,_STAR_parent_STAR_49986,this$,this__41270__auto__,x49979_49996))
}))),om.dom.button.call(null,({"onClick": ((function (map__49992,map__49992__$1,username,password,password2,_STAR_reconciler_STAR_49982,_STAR_depth_STAR_49983,_STAR_shared_STAR_49984,_STAR_instrument_STAR_49985,_STAR_parent_STAR_49986,this$,this__41270__auto__,x49979_49996){
return (function (){
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_49986;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_49985;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_49984;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_49983;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_49982;
}});})(x49979_49996))
;
...
var x49994_50000 = ebtanas.ui.new_user.NewUser;
/** @nocollapse */
x49994_50000.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x49994_50000.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x49994_50000){
...
/** @nocollapse */
x49994_50000.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x49994_50000.om$next$IQuery$query$arity$1 = ((function (x49994_50000){
...
/** @nocollapse */
x49994_50000.om$next$Ident$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x49994_50000.om$next$Ident$ident$arity$2 = ((function (x49994_50000){
...
var x49995_50001 = ebtanas.ui.new_user.NewUser.prototype;

x49995_50001.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;


x49995_50001.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x49995_50001){
return (function (this$,params){
var this$__$1 = this;
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"new-user","new-user",1575436062),new cljs.core.Keyword("ui","username","ui/username",1605670678),"",new cljs.core.Keyword("ui","password","ui/password",417022099),"",new cljs.core.Keyword("ui","password2","ui/password2",557832013),""], null);
});})(x49995_50001))
...
x49995_50001.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;


x49995_50001.om$next$IQuery$query$arity$1 = ((function (x49995_50001){
return (function (this$){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword("ui","username","ui/username",1605670678),new cljs.core.Keyword("ui","password","ui/password",417022099),new cljs.core.Keyword("ui","password2","ui/password2",557832013)], null);
});})(x49995_50001))
...
x49995_50001.om$next$Ident$ = cljs.core.PROTOCOL_SENTINEL;


x49995_50001.om$next$Ident$ident$arity$2 = ((function (x49995_50001){
return (function (this$,props){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"new-user","new-user",1575436062),new cljs.core.Keyword(null,"page","page",849072397)], null);
});})(x49995_50001))
...
//# sourceMappingURL=new_user.js.map?rel=1491695665420