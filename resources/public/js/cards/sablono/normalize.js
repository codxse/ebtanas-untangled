...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__206388_SHARP_){
return ((p1__206388_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__206388_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__206390,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__206390;
}
});
...
var len__40427__auto___206393 = arguments.length;
var i__40428__auto___206394 = (0);
while(true){
if((i__40428__auto___206394 < len__40427__auto___206393)){
args__40434__auto__.push((arguments[i__40428__auto___206394]));

var G__206395 = (i__40428__auto___206394 + (1));
i__40428__auto___206394 = G__206395;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__40435__auto__);
});
...
var G__206392 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__206392,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__206392;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq206391){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq206391));
});
...
var vec__206401 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("Can't match CSS tag: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__206401,(0),null);
var names = cljs.core.nth.call(null,vec__206401,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__206401,tag_name,names){
return (function (p1__206396_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__206396_SHARP_));
});})(matches,vec__206401,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__206401,tag_name,names){
return (function (p1__206397_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__206397_SHARP_));
});})(matches,vec__206401,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__206404){
var vec__206411 = p__206404;
var seq__206412 = cljs.core.seq.call(null,vec__206411);
var first__206413 = cljs.core.first.call(null,seq__206412);
var seq__206412__$1 = cljs.core.next.call(null,seq__206412);
var tag = first__206413;
var content = seq__206412__$1;
...
var vec__206414 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__206414,(0),null);
var id = cljs.core.nth.call(null,vec__206414,(1),null);
var class$ = cljs.core.nth.call(null,vec__206414,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1491715106834