...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__84566_SHARP_){
return ((p1__84566_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__84566_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__84568,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__84568;
}
});
...
var len__35776__auto___84571 = arguments.length;
var i__35777__auto___84572 = (0);
while(true){
if((i__35777__auto___84572 < len__35776__auto___84571)){
args__35783__auto__.push((arguments[i__35777__auto___84572]));

var G__84573 = (i__35777__auto___84572 + (1));
i__35777__auto___84572 = G__84573;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__35784__auto__);
});
...
var G__84570 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__84570,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__84570;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq84569){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq84569));
});
...
var vec__84579 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("Can't match CSS tag: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__84579,(0),null);
var names = cljs.core.nth.call(null,vec__84579,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__84579,tag_name,names){
return (function (p1__84574_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__84574_SHARP_));
});})(matches,vec__84579,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__84579,tag_name,names){
return (function (p1__84575_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__84575_SHARP_));
});})(matches,vec__84579,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__84582){
var vec__84589 = p__84582;
var seq__84590 = cljs.core.seq.call(null,vec__84589);
var first__84591 = cljs.core.first.call(null,seq__84590);
var seq__84590__$1 = cljs.core.next.call(null,seq__84590);
var tag = first__84591;
var content = seq__84590__$1;
...
var vec__84592 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__84592,(0),null);
var id = cljs.core.nth.call(null,vec__84592,(1),null);
var class$ = cljs.core.nth.call(null,vec__84592,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1491640820527