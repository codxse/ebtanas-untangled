...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__195057 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__195058 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__195058,x_SINGLEQUOTE__195057,this$){
return (function (p1__195056_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__195056_SHARP_,id_SINGLEQUOTE__195058),id,x_SINGLEQUOTE__195057);
});})(id_SINGLEQUOTE__195058,x_SINGLEQUOTE__195057,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__195057);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__39863__auto__,writer__39864__auto__,opt__39865__auto__){
return cljs.core._write.call(null,writer__39864__auto__,"om.next.cache/Cache");
});
...
//# sourceMappingURL=cache.js.map?rel=1491715084970