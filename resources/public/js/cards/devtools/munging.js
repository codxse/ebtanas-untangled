...
try{var o__77910__auto___212386 = t;
goog.object.get(o__77910__auto___212386,"cljs$lang$ctorPrWriter").call(o__77910__auto___212386,t,writer);
}catch (e212385){var __212387 = e212385;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__212389 = num_code;
switch (G__212389) {
case (1):
return (185);
...
}catch (e212395){var e__77935__auto__ = e212395;
return false;
}})())){
...
var vec__212396 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__212396,(0),null);
...
var len__40427__auto___212405 = arguments.length;
var i__40428__auto___212406 = (0);
while(true){
if((i__40428__auto___212406 < len__40427__auto___212405)){
args__40434__auto__.push((arguments[i__40428__auto___212406]));

var G__212407 = (i__40428__auto___212406 + (1));
i__40428__auto___212406 = G__212407;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__212401){
var vec__212402 = p__212401;
var ns_detector = cljs.core.nth.call(null,vec__212402,(0),null);
...
var G__212408 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__212409 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__212408;
remaining_tokens = G__212409;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq212399){
var G__212400 = cljs.core.first.call(null,seq212399);
var seq212399__$1 = cljs.core.next.call(null,seq212399);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__212400,seq212399__$1);
});
...
var vec__212417 = cljs.core.split_with.call(null,(function (p1__212413_SHARP_){
return cljs.core.not_EQ_.call(null,p1__212413_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__212417,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__212417,(1),null);
...
var vec__212423 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__212423,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__212423,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__212426 = cljs.core.rest.call(null,remaining_tokens);
var G__212427 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__212426;
name_tokens = G__212427;
continue;
} else {
...
var args212428 = [];
var len__40427__auto___212440 = arguments.length;
var i__40428__auto___212441 = (0);
while(true){
if((i__40428__auto___212441 < len__40427__auto___212440)){
args212428.push((arguments[i__40428__auto___212441]));

var G__212442 = (i__40428__auto___212441 + (1));
i__40428__auto___212441 = G__212442;
continue;
} else {
}
break;
...
var G__212430 = args212428.length;
switch (G__212430) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args212428.length)].join('')));
...
var vec__212431 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__212431,(0),null);
var arity = cljs.core.nth.call(null,vec__212431,(1),null);
var vec__212434 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__212434,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__212434,(1),null);
var vec__212437 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__212437,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__212437,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__212437,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__212437,(3),null);
...
var args212444 = [];
var len__40427__auto___212450 = arguments.length;
var i__40428__auto___212451 = (0);
while(true){
if((i__40428__auto___212451 < len__40427__auto___212450)){
args212444.push((arguments[i__40428__auto___212451]));

var G__212452 = (i__40428__auto___212451 + (1));
i__40428__auto___212451 = G__212452;
continue;
} else {
}
break;
...
var G__212446 = args212444.length;
switch (G__212446) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args212444.length)].join('')));
...
var vec__212447 = result;
var munged_ns = cljs.core.nth.call(null,vec__212447,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__212447,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__212447,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__212447,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__212447,(4),null);
var arity = cljs.core.nth.call(null,vec__212447,(5),null);
...
if(cljs.core.truth_(temp__6751__auto__)){
var vec__212460 = temp__6751__auto__;
var munged_name = cljs.core.nth.call(null,vec__212460,(0),null);
var args = cljs.core.nth.call(null,vec__212460,(1),null);
var vec__212463 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__212463,(0),null);
var name = cljs.core.nth.call(null,vec__212463,(1),null);
...
var G__212466 = (arity + (1));
var G__212467 = (function (){var temp__6751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__212468){
var vec__212472 = p__212468;
var arity = cljs.core.nth.call(null,vec__212472,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__212472,(1),null);
...
return (function (p1__212475_SHARP_){
return cljs.core.get.call(null,arities,p1__212475_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__212476_SHARP_){
return cljs.core.drop.call(null,(2),p1__212476_SHARP_);
...
var args__40434__auto__ = [];
var len__40427__auto___212483 = arguments.length;
var i__40428__auto___212484 = (0);
while(true){
if((i__40428__auto___212484 < len__40427__auto___212483)){
args__40434__auto__.push((arguments[i__40428__auto___212484]));

var G__212485 = (i__40428__auto___212484 + (1));
i__40428__auto___212484 = G__212485;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__212479){
var vec__212480 = p__212479;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__212480,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq212477){
var G__212478 = cljs.core.first.call(null,seq212477);
var seq212477__$1 = cljs.core.next.call(null,seq212477);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__212478,seq212477__$1);
});
...
var G__212487 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__212487) {
...
var map__212494 = options;
var map__212494__$1 = ((((!((map__212494 == null)))?((((map__212494.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__212494.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__212494):map__212494);
var include_ns_QMARK_ = cljs.core.get.call(null,map__212494__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__212494__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__212494__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__212494__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__212495 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__212495,(0),null);
var fn_name = cljs.core.nth.call(null,vec__212495,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__212495,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__212495,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__212495,(4),null);
var arity = cljs.core.nth.call(null,vec__212495,(5),null);
...
}catch (e212500){var e__77935__auto__ = e212500;
...
var G__212501 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__212502 = cljs.core.rest.call(null,path);
obj = G__212501;
path = G__212502;
continue;
} else {
...
return (function (accum,p__212507){
var vec__212508 = p__212507;
var bit = cljs.core.nth.call(null,vec__212508,(0),null);
var protocol = cljs.core.nth.call(null,vec__212508,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__212511){
var vec__212515 = p__212511;
var ns = cljs.core.nth.call(null,vec__212515,(0),null);
var name = cljs.core.nth.call(null,vec__212515,(1),null);
var selector = cljs.core.nth.call(null,vec__212515,(2),null);
...
return (function (p__212523){
var vec__212524 = p__212523;
var munged_name = cljs.core.nth.call(null,vec__212524,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__212524,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__212524,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__212518_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__212518_SHARP_));
});})(name,sorted_matches,vec__212524,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1491715115174