...
try{var o__67744__auto___91312 = t;
goog.object.get(o__67744__auto___91312,"cljs$lang$ctorPrWriter").call(o__67744__auto___91312,t,writer);
}catch (e91311){var __91313 = e91311;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__91315 = num_code;
switch (G__91315) {
case (1):
return (185);
...
}catch (e91321){var e__67769__auto__ = e91321;
return false;
}})())){
...
var vec__91322 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__91322,(0),null);
...
var len__35776__auto___91331 = arguments.length;
var i__35777__auto___91332 = (0);
while(true){
if((i__35777__auto___91332 < len__35776__auto___91331)){
args__35783__auto__.push((arguments[i__35777__auto___91332]));

var G__91333 = (i__35777__auto___91332 + (1));
i__35777__auto___91332 = G__91333;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__91327){
var vec__91328 = p__91327;
var ns_detector = cljs.core.nth.call(null,vec__91328,(0),null);
...
var G__91334 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__91335 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__91334;
remaining_tokens = G__91335;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq91325){
var G__91326 = cljs.core.first.call(null,seq91325);
var seq91325__$1 = cljs.core.next.call(null,seq91325);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__91326,seq91325__$1);
});
...
var vec__91343 = cljs.core.split_with.call(null,(function (p1__91339_SHARP_){
return cljs.core.not_EQ_.call(null,p1__91339_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__91343,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__91343,(1),null);
...
var vec__91349 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__91349,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__91349,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__91352 = cljs.core.rest.call(null,remaining_tokens);
var G__91353 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__91352;
name_tokens = G__91353;
continue;
} else {
...
var args91354 = [];
var len__35776__auto___91366 = arguments.length;
var i__35777__auto___91367 = (0);
while(true){
if((i__35777__auto___91367 < len__35776__auto___91366)){
args91354.push((arguments[i__35777__auto___91367]));

var G__91368 = (i__35777__auto___91367 + (1));
i__35777__auto___91367 = G__91368;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args91354.length)].join('')));
...
var vec__91357 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__91357,(0),null);
var arity = cljs.core.nth.call(null,vec__91357,(1),null);
var vec__91360 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__91360,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__91360,(1),null);
var vec__91363 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__91363,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__91363,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__91363,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__91363,(3),null);
...
var args91370 = [];
var len__35776__auto___91376 = arguments.length;
var i__35777__auto___91377 = (0);
while(true){
if((i__35777__auto___91377 < len__35776__auto___91376)){
args91370.push((arguments[i__35777__auto___91377]));

var G__91378 = (i__35777__auto___91377 + (1));
i__35777__auto___91377 = G__91378;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args91370.length)].join('')));
...
var vec__91373 = result;
var munged_ns = cljs.core.nth.call(null,vec__91373,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__91373,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__91373,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__91373,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__91373,(4),null);
var arity = cljs.core.nth.call(null,vec__91373,(5),null);
...
if(cljs.core.truth_(temp__6751__auto__)){
var vec__91386 = temp__6751__auto__;
var munged_name = cljs.core.nth.call(null,vec__91386,(0),null);
var args = cljs.core.nth.call(null,vec__91386,(1),null);
var vec__91389 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__91389,(0),null);
var name = cljs.core.nth.call(null,vec__91389,(1),null);
...
var G__91392 = (arity + (1));
var G__91393 = (function (){var temp__6751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__91394){
var vec__91398 = p__91394;
var arity = cljs.core.nth.call(null,vec__91398,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__91398,(1),null);
...
return (function (p1__91401_SHARP_){
return cljs.core.get.call(null,arities,p1__91401_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__91402_SHARP_){
return cljs.core.drop.call(null,(2),p1__91402_SHARP_);
...
var args__35783__auto__ = [];
var len__35776__auto___91409 = arguments.length;
var i__35777__auto___91410 = (0);
while(true){
if((i__35777__auto___91410 < len__35776__auto___91409)){
args__35783__auto__.push((arguments[i__35777__auto___91410]));

var G__91411 = (i__35777__auto___91410 + (1));
i__35777__auto___91410 = G__91411;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__91405){
var vec__91406 = p__91405;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__91406,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq91403){
var G__91404 = cljs.core.first.call(null,seq91403);
var seq91403__$1 = cljs.core.next.call(null,seq91403);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__91404,seq91403__$1);
});
...
var G__91413 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__91413) {
...
var map__91420 = options;
var map__91420__$1 = ((((!((map__91420 == null)))?((((map__91420.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__91420.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__91420):map__91420);
var include_ns_QMARK_ = cljs.core.get.call(null,map__91420__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__91420__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__91420__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__91420__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__91421 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__91421,(0),null);
var fn_name = cljs.core.nth.call(null,vec__91421,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__91421,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__91421,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__91421,(4),null);
var arity = cljs.core.nth.call(null,vec__91421,(5),null);
...
}catch (e91426){var e__67769__auto__ = e91426;
...
var G__91427 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__91428 = cljs.core.rest.call(null,path);
obj = G__91427;
path = G__91428;
continue;
} else {
...
return (function (accum,p__91433){
var vec__91434 = p__91433;
var bit = cljs.core.nth.call(null,vec__91434,(0),null);
var protocol = cljs.core.nth.call(null,vec__91434,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__91437){
var vec__91441 = p__91437;
var ns = cljs.core.nth.call(null,vec__91441,(0),null);
var name = cljs.core.nth.call(null,vec__91441,(1),null);
var selector = cljs.core.nth.call(null,vec__91441,(2),null);
...
return (function (p__91449){
var vec__91450 = p__91449;
var munged_name = cljs.core.nth.call(null,vec__91450,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__91450,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__91450,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__91444_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__91444_SHARP_));
});})(name,sorted_matches,vec__91450,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1491640827853