...
var G__91455 = devtools.prefs.pref.call(null,v);
v = G__91455;
continue;
} else {
return v;
...
}catch (e91468){var e__67769__auto__ = e91468;
return false;
}})();
...
}catch (e91472){var e__67769__auto__ = e91472;
return false;
}})();
...
}catch (e91474){var e__67769__auto__ = e91474;
return false;
}}
}
});
...
var vec__91479 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__91479,(0),null);
var name = cljs.core.nth.call(null,vec__91479,(1),null);
...
return cljs.core.some.call(null,(function (p1__91482_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__91482_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1491640827941