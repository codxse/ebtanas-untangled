...
var len__35776__auto___91489 = arguments.length;
var i__35777__auto___91490 = (0);
while(true){
if((i__35777__auto___91490 < len__35776__auto___91489)){
args__35783__auto__.push((arguments[i__35777__auto___91490]));

var G__91491 = (i__35777__auto___91490 + (1));
i__35777__auto___91490 = G__91491;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq91487){
var G__91488 = cljs.core.first.call(null,seq91487);
var seq91487__$1 = cljs.core.next.call(null,seq91487);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__91488,seq91487__$1);
});
...
return (function (p1__91492_SHARP_){
return (p1__91492_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1491640827983