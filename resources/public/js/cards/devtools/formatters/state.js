...
var len__40427__auto___212563 = arguments.length;
var i__40428__auto___212564 = (0);
while(true){
if((i__40428__auto___212564 < len__40427__auto___212563)){
args__40434__auto__.push((arguments[i__40428__auto___212564]));

var G__212565 = (i__40428__auto___212564 + (1));
i__40428__auto___212564 = G__212565;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__40435__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq212561){
var G__212562 = cljs.core.first.call(null,seq212561);
var seq212561__$1 = cljs.core.next.call(null,seq212561);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__212562,seq212561__$1);
});
...
return (function (p1__212566_SHARP_){
return (p1__212566_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1491715115333