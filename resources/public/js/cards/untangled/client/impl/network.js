...
var args45630 = [];
var len__40443__auto___45634 = arguments.length;
var i__40444__auto___45635 = (0);
while(true){
if((i__40444__auto___45635 < len__40443__auto___45634)){
args45630.push((arguments[i__40444__auto___45635]));

var G__45636 = (i__40444__auto___45635 + (1));
i__40444__auto___45635 = G__45636;
continue;
} else {
}
break;
...
untangled.client.impl.network.Network.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__39899__auto__,k45639,else__39900__auto__){
var self__ = this;
var this__39899__auto____$1 = this;
var G__45641 = (((k45639 instanceof cljs.core.Keyword))?k45639.fqn:null);
switch (G__45641) {
case "url":
return self__.url;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k45639,else__39900__auto__);
...
untangled.client.impl.network.Network.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45638){
var self__ = this;
var G__45638__$1 = this;
return (new cljs.core.RecordIter((0),G__45638__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
var map__45642 = (function (){var G__45643 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"body","body",-2049205669),edn,new cljs.core.Keyword(null,"headers","headers",-835030129),headers], null);
if(cljs.core.truth_(self__.request_transform)){
return self__.request_transform.call(null,G__45643);
} else {
return G__45643;
}
})();
...
var body = cljs.core.get.call(null,map__45642__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var headers__$1 = cljs.core.get.call(null,map__45642__$1,new cljs.core.Keyword(null,"headers","headers",-835030129));
...
goog.events.listen(xhrio,goog.net.EventType.SUCCESS,((function (xhrio,handlers,headers,map__45642,map__45642__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
return untangled.client.impl.network.response_ok.call(null,this$__$1,xhrio,ok);
});})(xhrio,handlers,headers,map__45642,map__45642__$1,body,headers__$1,post_data,headers__$2,this$__$1))
);

return goog.events.listen(xhrio,goog.net.EventType.ERROR,((function (xhrio,handlers,headers,map__45642,map__45642__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
...
untangled.client.impl.network.Network.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__39904__auto__,k__39905__auto__,G__45638){
var self__ = this;
var this__39904__auto____$1 = this;
var pred__45645 = cljs.core.keyword_identical_QMARK_;
var expr__45646 = k__39905__auto__;
if(cljs.core.truth_(pred__45645.call(null,new cljs.core.Keyword(null,"url","url",276297046),expr__45646))){
return (new untangled.client.impl.network.Network(G__45638,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__45645.call(null,new cljs.core.Keyword(null,"request-transform","request-transform",170337297),expr__45646))){
return (new untangled.client.impl.network.Network(self__.url,G__45638,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__45645.call(null,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),expr__45646))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,G__45638,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__45645.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__45646))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,G__45638,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__45645.call(null,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791),expr__45646))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,G__45638,self__.__meta,self__.__extmap,null));
} else {
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__39905__auto__,G__45638),null));
}
}
}
}
...
untangled.client.impl.network.Network.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__39896__auto__,G__45638){
var self__ = this;
var this__39896__auto____$1 = this;
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,G__45638,self__.__extmap,self__.__hash));
});
...
untangled.client.impl.network.map__GT_Network = (function untangled$client$impl$network$map__GT_Network(G__45640){
return (new untangled.client.impl.network.Network(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(G__45640),new cljs.core.Keyword(null,"request-transform","request-transform",170337297).cljs$core$IFn$_invoke$arity$1(G__45640),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631).cljs$core$IFn$_invoke$arity$1(G__45640),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__45640),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791).cljs$core$IFn$_invoke$arity$1(G__45640),null,cljs.core.dissoc.call(null,G__45640,new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)),null));
});
...
var len__40443__auto___45654 = arguments.length;
var i__40444__auto___45655 = (0);
while(true){
if((i__40444__auto___45655 < len__40443__auto___45654)){
args__40450__auto__.push((arguments[i__40444__auto___45655]));

var G__45656 = (i__40444__auto___45655 + (1));
i__40444__auto___45655 = G__45656;
continue;
} else {
}
break;
...
untangled.client.impl.network.make_untangled_network.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__45651){
var map__45652 = p__45651;
var map__45652__$1 = ((((!((map__45652 == null)))?((((map__45652.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45652.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45652):map__45652);
var request_transform = cljs.core.get.call(null,map__45652__$1,new cljs.core.Keyword(null,"request-transform","request-transform",170337297));
var global_error_callback = cljs.core.get.call(null,map__45652__$1,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631));
var transit_handlers = cljs.core.get.call(null,map__45652__$1,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791));
...
untangled.client.impl.network.make_untangled_network.cljs$lang$applyTo = (function (seq45649){
var G__45650 = cljs.core.first.call(null,seq45649);
var seq45649__$1 = cljs.core.next.call(null,seq45649);
return untangled.client.impl.network.make_untangled_network.cljs$core$IFn$_invoke$arity$variadic(G__45650,seq45649__$1);
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__39899__auto__,k45658,else__39900__auto__){
var self__ = this;
var this__39899__auto____$1 = this;
var G__45660 = (((k45658 instanceof cljs.core.Keyword))?k45658.fqn:null);
switch (G__45660) {
case "complete-app":
return self__.complete_app;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k45658,else__39900__auto__);
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45657){
var self__ = this;
var G__45657__$1 = this;
return (new cljs.core.RecordIter((0),G__45657__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__39904__auto__,k__39905__auto__,G__45657){
var self__ = this;
var this__39904__auto____$1 = this;
var pred__45661 = cljs.core.keyword_identical_QMARK_;
var expr__45662 = k__39905__auto__;
if(cljs.core.truth_(pred__45661.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__45662))){
return (new untangled.client.impl.network.MockNetwork(G__45657,self__.__meta,self__.__extmap,null));
} else {
return (new untangled.client.impl.network.MockNetwork(self__.complete_app,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__39905__auto__,G__45657),null));
}
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__39896__auto__,G__45657){
var self__ = this;
var this__39896__auto____$1 = this;
return (new untangled.client.impl.network.MockNetwork(self__.complete_app,G__45657,self__.__extmap,self__.__hash));
});
...
untangled.client.impl.network.map__GT_MockNetwork = (function untangled$client$impl$network$map__GT_MockNetwork(G__45659){
return (new untangled.client.impl.network.MockNetwork(new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__45659),null,cljs.core.dissoc.call(null,G__45659,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)),null));
});
...
//# sourceMappingURL=network.js.map?rel=1491695660020