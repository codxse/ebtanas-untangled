...
var args45374 = [];
var len__35776__auto___45378 = arguments.length;
var i__35777__auto___45379 = (0);
while(true){
if((i__35777__auto___45379 < len__35776__auto___45378)){
args45374.push((arguments[i__35777__auto___45379]));

var G__45380 = (i__35777__auto___45379 + (1));
i__35777__auto___45379 = G__45380;
continue;
} else {
}
break;
...
}catch (e45377){if((e45377 instanceof Object)){
var e = e45377;
...
untangled.client.impl.network.Network.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35232__auto__,k45383,else__35233__auto__){
var self__ = this;
var this__35232__auto____$1 = this;
var G__45385 = (((k45383 instanceof cljs.core.Keyword))?k45383.fqn:null);
switch (G__45385) {
case "url":
return self__.url;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k45383,else__35233__auto__);
...
untangled.client.impl.network.Network.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45382){
var self__ = this;
var G__45382__$1 = this;
return (new cljs.core.RecordIter((0),G__45382__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
var map__45386 = (function (){var G__45387 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"body","body",-2049205669),edn,new cljs.core.Keyword(null,"headers","headers",-835030129),headers], null);
if(cljs.core.truth_(self__.request_transform)){
return self__.request_transform.call(null,G__45387);
} else {
return G__45387;
}
})();
...
var body = cljs.core.get.call(null,map__45386__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var headers__$1 = cljs.core.get.call(null,map__45386__$1,new cljs.core.Keyword(null,"headers","headers",-835030129));
...
goog.events.listen(xhrio,goog.net.EventType.SUCCESS,((function (xhrio,handlers,headers,map__45386,map__45386__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
return untangled.client.impl.network.response_ok.call(null,this$__$1,xhrio,ok);
});})(xhrio,handlers,headers,map__45386,map__45386__$1,body,headers__$1,post_data,headers__$2,this$__$1))
);

return goog.events.listen(xhrio,goog.net.EventType.ERROR,((function (xhrio,handlers,headers,map__45386,map__45386__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
...
untangled.client.impl.network.Network.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35237__auto__,k__35238__auto__,G__45382){
var self__ = this;
var this__35237__auto____$1 = this;
var pred__45389 = cljs.core.keyword_identical_QMARK_;
var expr__45390 = k__35238__auto__;
if(cljs.core.truth_(pred__45389.call(null,new cljs.core.Keyword(null,"url","url",276297046),expr__45390))){
return (new untangled.client.impl.network.Network(G__45382,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__45389.call(null,new cljs.core.Keyword(null,"request-transform","request-transform",170337297),expr__45390))){
return (new untangled.client.impl.network.Network(self__.url,G__45382,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__45389.call(null,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),expr__45390))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,G__45382,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__45389.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__45390))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,G__45382,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__45389.call(null,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791),expr__45390))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,G__45382,self__.__meta,self__.__extmap,null));
} else {
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35238__auto__,G__45382),null));
}
}
}
}
...
untangled.client.impl.network.Network.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35229__auto__,G__45382){
var self__ = this;
var this__35229__auto____$1 = this;
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,G__45382,self__.__extmap,self__.__hash));
});
...
untangled.client.impl.network.map__GT_Network = (function untangled$client$impl$network$map__GT_Network(G__45384){
return (new untangled.client.impl.network.Network(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(G__45384),new cljs.core.Keyword(null,"request-transform","request-transform",170337297).cljs$core$IFn$_invoke$arity$1(G__45384),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631).cljs$core$IFn$_invoke$arity$1(G__45384),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__45384),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791).cljs$core$IFn$_invoke$arity$1(G__45384),null,cljs.core.dissoc.call(null,G__45384,new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)),null));
});
...
var len__35776__auto___45398 = arguments.length;
var i__35777__auto___45399 = (0);
while(true){
if((i__35777__auto___45399 < len__35776__auto___45398)){
args__35783__auto__.push((arguments[i__35777__auto___45399]));

var G__45400 = (i__35777__auto___45399 + (1));
i__35777__auto___45399 = G__45400;
continue;
} else {
}
break;
...
untangled.client.impl.network.make_untangled_network.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__45395){
...
var request_transform = cljs.core.get.call(null,map__45396__$1,new cljs.core.Keyword(null,"request-transform","request-transform",170337297));
var global_error_callback = cljs.core.get.call(null,map__45396__$1,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631));
var transit_handlers = cljs.core.get.call(null,map__45396__$1,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791));
...
untangled.client.impl.network.make_untangled_network.cljs$lang$applyTo = (function (seq45393){
var G__45394 = cljs.core.first.call(null,seq45393);
var seq45393__$1 = cljs.core.next.call(null,seq45393);
return untangled.client.impl.network.make_untangled_network.cljs$core$IFn$_invoke$arity$variadic(G__45394,seq45393__$1);
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35232__auto__,k45402,else__35233__auto__){
var self__ = this;
var this__35232__auto____$1 = this;
var G__45404 = (((k45402 instanceof cljs.core.Keyword))?k45402.fqn:null);
switch (G__45404) {
case "complete-app":
return self__.complete_app;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k45402,else__35233__auto__);
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45401){
var self__ = this;
var G__45401__$1 = this;
return (new cljs.core.RecordIter((0),G__45401__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35237__auto__,k__35238__auto__,G__45401){
var self__ = this;
var this__35237__auto____$1 = this;
var pred__45405 = cljs.core.keyword_identical_QMARK_;
var expr__45406 = k__35238__auto__;
if(cljs.core.truth_(pred__45405.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__45406))){
return (new untangled.client.impl.network.MockNetwork(G__45401,self__.__meta,self__.__extmap,null));
} else {
return (new untangled.client.impl.network.MockNetwork(self__.complete_app,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35238__auto__,G__45401),null));
}
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35229__auto__,G__45401){
var self__ = this;
var this__35229__auto____$1 = this;
return (new untangled.client.impl.network.MockNetwork(self__.complete_app,G__45401,self__.__extmap,self__.__hash));
});
...
untangled.client.impl.network.map__GT_MockNetwork = (function untangled$client$impl$network$map__GT_MockNetwork(G__45403){
return (new untangled.client.impl.network.MockNetwork(new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__45403),null,cljs.core.dissoc.call(null,G__45403,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)),null));
});
...
//# sourceMappingURL=network.js.map?rel=1491640759728