...
var args181751 = [];
var len__40427__auto___181755 = arguments.length;
var i__40428__auto___181756 = (0);
while(true){
if((i__40428__auto___181756 < len__40427__auto___181755)){
args181751.push((arguments[i__40428__auto___181756]));

var G__181757 = (i__40428__auto___181756 + (1));
i__40428__auto___181756 = G__181757;
continue;
} else {
}
break;
...
var G__181753 = args181751.length;
switch (G__181753) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args181751.length)].join('')));
...
}catch (e181754){if((e181754 instanceof Object)){
var e = e181754;
...
untangled.client.impl.network.Network.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__39883__auto__,k181760,else__39884__auto__){
var self__ = this;
var this__39883__auto____$1 = this;
var G__181762 = (((k181760 instanceof cljs.core.Keyword))?k181760.fqn:null);
switch (G__181762) {
case "url":
return self__.url;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k181760,else__39884__auto__);
...
untangled.client.impl.network.Network.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__181759){
var self__ = this;
var G__181759__$1 = this;
return (new cljs.core.RecordIter((0),G__181759__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
var map__181763 = (function (){var G__181764 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"body","body",-2049205669),edn,new cljs.core.Keyword(null,"headers","headers",-835030129),headers], null);
if(cljs.core.truth_(self__.request_transform)){
return self__.request_transform.call(null,G__181764);
} else {
return G__181764;
}
})();
var map__181763__$1 = ((((!((map__181763 == null)))?((((map__181763.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__181763.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__181763):map__181763);
var body = cljs.core.get.call(null,map__181763__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var headers__$1 = cljs.core.get.call(null,map__181763__$1,new cljs.core.Keyword(null,"headers","headers",-835030129));
...
goog.events.listen(xhrio,goog.net.EventType.SUCCESS,((function (xhrio,handlers,headers,map__181763,map__181763__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
return untangled.client.impl.network.response_ok.call(null,this$__$1,xhrio,ok);
});})(xhrio,handlers,headers,map__181763,map__181763__$1,body,headers__$1,post_data,headers__$2,this$__$1))
);

return goog.events.listen(xhrio,goog.net.EventType.ERROR,((function (xhrio,handlers,headers,map__181763,map__181763__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
...
untangled.client.impl.network.Network.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__39888__auto__,k__39889__auto__,G__181759){
var self__ = this;
var this__39888__auto____$1 = this;
var pred__181766 = cljs.core.keyword_identical_QMARK_;
var expr__181767 = k__39889__auto__;
if(cljs.core.truth_(pred__181766.call(null,new cljs.core.Keyword(null,"url","url",276297046),expr__181767))){
return (new untangled.client.impl.network.Network(G__181759,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__181766.call(null,new cljs.core.Keyword(null,"request-transform","request-transform",170337297),expr__181767))){
return (new untangled.client.impl.network.Network(self__.url,G__181759,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__181766.call(null,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),expr__181767))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,G__181759,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__181766.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__181767))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,G__181759,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__181766.call(null,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791),expr__181767))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,G__181759,self__.__meta,self__.__extmap,null));
} else {
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__39889__auto__,G__181759),null));
}
}
}
}
...
untangled.client.impl.network.Network.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__39880__auto__,G__181759){
var self__ = this;
var this__39880__auto____$1 = this;
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,G__181759,self__.__extmap,self__.__hash));
});
...
untangled.client.impl.network.map__GT_Network = (function untangled$client$impl$network$map__GT_Network(G__181761){
return (new untangled.client.impl.network.Network(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(G__181761),new cljs.core.Keyword(null,"request-transform","request-transform",170337297).cljs$core$IFn$_invoke$arity$1(G__181761),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631).cljs$core$IFn$_invoke$arity$1(G__181761),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__181761),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791).cljs$core$IFn$_invoke$arity$1(G__181761),null,cljs.core.dissoc.call(null,G__181761,new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)),null));
});
...
var len__40427__auto___181775 = arguments.length;
var i__40428__auto___181776 = (0);
while(true){
if((i__40428__auto___181776 < len__40427__auto___181775)){
args__40434__auto__.push((arguments[i__40428__auto___181776]));

var G__181777 = (i__40428__auto___181776 + (1));
i__40428__auto___181776 = G__181777;
continue;
} else {
}
break;
...
untangled.client.impl.network.make_untangled_network.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__181772){
var map__181773 = p__181772;
var map__181773__$1 = ((((!((map__181773 == null)))?((((map__181773.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__181773.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__181773):map__181773);
var request_transform = cljs.core.get.call(null,map__181773__$1,new cljs.core.Keyword(null,"request-transform","request-transform",170337297));
var global_error_callback = cljs.core.get.call(null,map__181773__$1,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631));
var transit_handlers = cljs.core.get.call(null,map__181773__$1,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791));
...
untangled.client.impl.network.make_untangled_network.cljs$lang$applyTo = (function (seq181770){
var G__181771 = cljs.core.first.call(null,seq181770);
var seq181770__$1 = cljs.core.next.call(null,seq181770);
return untangled.client.impl.network.make_untangled_network.cljs$core$IFn$_invoke$arity$variadic(G__181771,seq181770__$1);
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__39883__auto__,k181779,else__39884__auto__){
var self__ = this;
var this__39883__auto____$1 = this;
var G__181781 = (((k181779 instanceof cljs.core.Keyword))?k181779.fqn:null);
switch (G__181781) {
case "complete-app":
return self__.complete_app;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k181779,else__39884__auto__);
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__181778){
var self__ = this;
var G__181778__$1 = this;
return (new cljs.core.RecordIter((0),G__181778__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__39888__auto__,k__39889__auto__,G__181778){
var self__ = this;
var this__39888__auto____$1 = this;
var pred__181782 = cljs.core.keyword_identical_QMARK_;
var expr__181783 = k__39889__auto__;
if(cljs.core.truth_(pred__181782.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__181783))){
return (new untangled.client.impl.network.MockNetwork(G__181778,self__.__meta,self__.__extmap,null));
} else {
return (new untangled.client.impl.network.MockNetwork(self__.complete_app,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__39889__auto__,G__181778),null));
}
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__39880__auto__,G__181778){
var self__ = this;
var this__39880__auto____$1 = this;
return (new untangled.client.impl.network.MockNetwork(self__.complete_app,G__181778,self__.__extmap,self__.__hash));
});
...
untangled.client.impl.network.map__GT_MockNetwork = (function untangled$client$impl$network$map__GT_MockNetwork(G__181780){
return (new untangled.client.impl.network.MockNetwork(new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__181780),null,cljs.core.dissoc.call(null,G__181780,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)),null));
});
...
//# sourceMappingURL=network.js.map?rel=1491715062328