...
var G__192363 = devtools.prefs.pref.call(null,v);
v = G__192363;
continue;
} else {
return v;
...
}catch (e192376){var e__77935__auto__ = e192376;
return false;
}})();
...
}catch (e192380){var e__77935__auto__ = e192380;
return false;
}})();
...
}catch (e192382){var e__77935__auto__ = e192382;
return false;
}}
}
});
...
var vec__192387 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__192387,(0),null);
var name = cljs.core.nth.call(null,vec__192387,(1),null);
...
return cljs.core.some.call(null,(function (p1__192390_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__192390_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1491715078362