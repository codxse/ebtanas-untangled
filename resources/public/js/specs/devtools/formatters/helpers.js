...
var G__70402 = devtools.prefs.pref.call(null,v);
v = G__70402;
continue;
} else {
return v;
...
}catch (e70415){var e__67769__auto__ = e70415;
return false;
}})();
...
}catch (e70419){var e__67769__auto__ = e70419;
return false;
}})();
...
}catch (e70421){var e__67769__auto__ = e70421;
return false;
}}
}
});
...
var vec__70426 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__70426,(0),null);
var name = cljs.core.nth.call(null,vec__70426,(1),null);
...
return cljs.core.some.call(null,(function (p1__70429_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__70429_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1491640789490