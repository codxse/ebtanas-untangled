...
taoensso.sente.packers.transit.TransitPacker.cljs$lang$ctorPrWriter = (function (this__35212__auto__,writer__35213__auto__,opt__35214__auto__){
return cljs.core._write.call(null,writer__35213__auto__,"taoensso.sente.packers.transit/TransitPacker");
});
...
var args53810 = [];
var len__35776__auto___53816 = arguments.length;
var i__35777__auto___53817 = (0);
while(true){
if((i__35777__auto___53817 < len__35776__auto___53816)){
args53810.push((arguments[i__35777__auto___53817]));

var G__53818 = (i__35777__auto___53817 + (1));
i__35777__auto___53817 = G__53818;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args53810.length)].join('')));
...
var e_53820 = (function (){try{if((function (x){
...
}catch (e53813){if((e53813 instanceof Error)){
var e = e53813;
return e;
} else {
throw e53813;
...
taoensso.truss.impl._invar_violation_BANG_.call(null,true,"taoensso.sente.packers.transit",102,"([:el #{:json}] transit-fmt)",transit_fmt,e_53820,null);
}
...
}catch (e53814){if((e53814 instanceof Error)){
var e = e53814;
return e;
} else {
throw e53814;
...
//# sourceMappingURL=transit.js.map?rel=1491640769232