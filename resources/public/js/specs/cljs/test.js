...
var args52718 = [];
var len__35776__auto___52722 = arguments.length;
var i__35777__auto___52723 = (0);
while(true){
if((i__35777__auto___52723 < len__35776__auto___52722)){
args52718.push((arguments[i__35777__auto___52723]));

var G__52724 = (i__35777__auto___52723 + (1));
i__35777__auto___52723 = G__52724;
continue;
} else {
}
break;
...
return cljs.core.assoc.call(null,G__52721,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__52721;
}
});
...
var len__35776__auto___52729 = arguments.length;
var i__35777__auto___52730 = (0);
while(true){
if((i__35777__auto___52730 < len__35776__auto___52729)){
args__35783__auto__.push((arguments[i__35777__auto___52730]));

var G__52731 = (i__35777__auto___52730 + (1));
i__35777__auto___52730 = G__52731;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq52726){
var G__52727 = cljs.core.first.call(null,seq52726);
var seq52726__$1 = cljs.core.next.call(null,seq52726);
var G__52728 = cljs.core.first.call(null,seq52726__$1);
var seq52726__$2 = cljs.core.next.call(null,seq52726__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__52727,G__52728,seq52726__$2);
});
...
var file = cljs.core.get.call(null,map__52735__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__52735__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__52735__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__52735,map__52735__$1,file,line,column){
return (function (p1__52732_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__52732_SHARP_));
});})(map__52735,map__52735__$1,file,line,column))
...
var temp__6753__auto___52737 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6753__auto___52737)){
var message_52738 = temp__6753__auto___52737;
cljs.core.println.call(null,message_52738);
} else {
}
...
var temp__6753__auto___52739 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6753__auto___52739)){
var message_52740 = temp__6753__auto___52739;
cljs.core.println.call(null,message_52740);
} else {
}
...
var G__52750 = exception.stack;
var G__52750__$1 = (((G__52750 == null))?null:clojure.string.split_lines.call(null,G__52750));
var G__52750__$2 = (((G__52750__$1 == null))?null:cljs.core.get.call(null,G__52750__$1,depth));
if((G__52750__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__52750__$2);
}
} else {
...
var vec__52751 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__52751,(0),null);
var column = cljs.core.nth.call(null,vec__52751,(1),null);
var vec__52754 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__52754,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__52754,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__52754,(2),null);
...
var m__$1 = (function (){var G__52758 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__52758) {
case "fail":
...
var G__52764 = (function (){var G__52763 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__52763);
} else {
return G__52763;
}
})();
...
return cljs.core.vary_meta.call(null,G__52766,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e52769){var e = e52769;
var G__52770 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__52770) {
...
var vec__52775 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__52775,(0),null);
var types = vec__52775;
...
return cljs.core.map.call(null,(function (p__52787){
var vec__52788 = p__52787;
var ns = cljs.core.nth.call(null,vec__52788,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__52788,(1),null);
return ((function (vec__52788,ns,vars__$1){
return (function (){
...
var G__52791 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__52791) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__52791,env,once_fixtures,each_fixtures,vec__52788,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__52791,env,once_fixtures,each_fixtures,vec__52788,ns,vars__$1){
return (function (){
var seq__52792 = cljs.core.seq.call(null,vars__$1);
var chunk__52793 = null;
var count__52794 = (0);
var i__52795 = (0);
while(true){
if((i__52795 < count__52794)){
var v = cljs.core._nth.call(null,chunk__52793,i__52795);
var temp__6753__auto___52797 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6753__auto___52797)){
var t_52798 = temp__6753__auto___52797;
each_fixture_fn.call(null,((function (seq__52792,chunk__52793,count__52794,i__52795,t_52798,temp__6753__auto___52797,v,each_fixture_fn,G__52791,env,once_fixtures,each_fixtures,vec__52788,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_52798)));
});})(seq__52792,chunk__52793,count__52794,i__52795,t_52798,temp__6753__auto___52797,v,each_fixture_fn,G__52791,env,once_fixtures,each_fixtures,vec__52788,ns,vars__$1))
);
} else {
}

var G__52799 = seq__52792;
var G__52800 = chunk__52793;
var G__52801 = count__52794;
var G__52802 = (i__52795 + (1));
seq__52792 = G__52799;
chunk__52793 = G__52800;
count__52794 = G__52801;
i__52795 = G__52802;
continue;
} else {
var temp__6753__auto__ = cljs.core.seq.call(null,seq__52792);
if(temp__6753__auto__){
var seq__52792__$1 = temp__6753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__52792__$1)){
var c__35466__auto__ = cljs.core.chunk_first.call(null,seq__52792__$1);
var G__52803 = cljs.core.chunk_rest.call(null,seq__52792__$1);
var G__52804 = c__35466__auto__;
var G__52805 = cljs.core.count.call(null,c__35466__auto__);
var G__52806 = (0);
seq__52792 = G__52803;
chunk__52793 = G__52804;
count__52794 = G__52805;
i__52795 = G__52806;
continue;
} else {
var v = cljs.core.first.call(null,seq__52792__$1);
var temp__6753__auto___52807__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6753__auto___52807__$1)){
var t_52808 = temp__6753__auto___52807__$1;
each_fixture_fn.call(null,((function (seq__52792,chunk__52793,count__52794,i__52795,t_52808,temp__6753__auto___52807__$1,v,seq__52792__$1,temp__6753__auto__,each_fixture_fn,G__52791,env,once_fixtures,each_fixtures,vec__52788,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_52808)));
});})(seq__52792,chunk__52793,count__52794,i__52795,t_52808,temp__6753__auto___52807__$1,v,seq__52792__$1,temp__6753__auto__,each_fixture_fn,G__52791,env,once_fixtures,each_fixtures,vec__52788,ns,vars__$1))
);
} else {
}

var G__52809 = cljs.core.next.call(null,seq__52792__$1);
var G__52810 = null;
var G__52811 = (0);
var G__52812 = (0);
seq__52792 = G__52809;
chunk__52793 = G__52810;
count__52794 = G__52811;
i__52795 = G__52812;
continue;
}
} else {
...
});})(each_fixture_fn,G__52791,env,once_fixtures,each_fixtures,vec__52788,ns,vars__$1))
);
});})(each_fixture_fn,G__52791,env,once_fixtures,each_fixtures,vec__52788,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1491640767355