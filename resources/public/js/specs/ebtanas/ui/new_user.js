...
var x187576_187588 = ebtanas.ui.new_user.NewUser.prototype;
x187576_187588.componentWillUpdate = ((function (x187576_187588){
...
var ident__41163__auto___187589 = om.next.ident.call(null,this__41159__auto__,om.next.props.call(null,this__41159__auto__));
var next_ident__41164__auto___187590 = om.next.ident.call(null,this__41159__auto__,om.next._next_props.call(null,next_props__41160__auto__,this__41159__auto__));
if(cljs.core.not_EQ_.call(null,ident__41163__auto___187589,next_ident__41164__auto___187590)){
var idxr__41165__auto___187591 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__41159__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__41165__auto___187591 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__41165__auto___187591),((function (idxr__41165__auto___187591,ident__41163__auto___187589,next_ident__41164__auto___187590,this__41159__auto__,x187576_187588){
return (function (indexes__41166__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__41166__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__41163__auto___187589], null),cljs.core.disj,this__41159__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__41164__auto___187590], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__41159__auto__);
});})(idxr__41165__auto___187591,ident__41163__auto___187589,next_ident__41164__auto___187590,this__41159__auto__,x187576_187588))
);
}
} else {
}
...
x187576_187588.shouldComponentUpdate = ((function (x187576_187588){
return (function (next_props__41160__auto__,next_state__41161__auto__){
var this__41159__auto__ = this;
...
var next_props__41160__auto____$2 = (function (){var G__187578 = next_props__41160__auto____$1;
if((next_props__41160__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__187578);
} else {
return G__187578;
}
})();
...
x187576_187588.componentWillUnmount = ((function (x187576_187588){
return (function (){
var this__41159__auto__ = this;
...
x187576_187588.componentDidUpdate = ((function (x187576_187588){
...
x187576_187588.isMounted = ((function (x187576_187588){
return (function (){
var this__41159__auto__ = this;
...
x187576_187588.componentWillMount = ((function (x187576_187588){
return (function (){
var this__41159__auto__ = this;
...
x187576_187588.render = ((function (x187576_187588){
return (function (){
var this__41158__auto__ = this;
var this$ = this__41158__auto__;
var _STAR_reconciler_STAR_187579 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_187580 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_187581 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_187582 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_187583 = om.next._STAR_parent_STAR_;
...
try{var map__187584 = om.next.props.call(null,this$);
var map__187584__$1 = ((((!((map__187584 == null)))?((((map__187584.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__187584.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__187584):map__187584);
var username = cljs.core.get.call(null,map__187584__$1,new cljs.core.Keyword("ui","username","ui/username",1605670678));
var password = cljs.core.get.call(null,map__187584__$1,new cljs.core.Keyword("ui","password","ui/password",417022099));
var password2 = cljs.core.get.call(null,map__187584__$1,new cljs.core.Keyword("ui","password2","ui/password2",557832013));
return om.dom.div.call(null,null,om.dom.div.call(null,({"className": "row"}),om.dom.div.call(null,({"className": "col-xs-4"}),""),om.dom.div.call(null,cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"className","className",-1983287057),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(om_css.core.local_class.call(null,ebtanas.ui.new_user.NewUser,"form")),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.str.cljs$core$IFn$_invoke$arity$1("col-xs-4"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" ")].join('')], null)),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "username"}),"Email Address"),om.dom.input.call(null,({"className": "form-control", "type": "email", "name": "username", "value": username, "onChange": ((function (map__187584,map__187584__$1,username,password,password2,_STAR_reconciler_STAR_187579,_STAR_depth_STAR_187580,_STAR_shared_STAR_187581,_STAR_instrument_STAR_187582,_STAR_parent_STAR_187583,this$,this__41158__auto__,x187576_187588){
return (function (p1__187569_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","username","ui/username",1605670678),new cljs.core.Keyword(null,"event","event",301435442),p1__187569_SHARP_);
});})(map__187584,map__187584__$1,username,password,password2,_STAR_reconciler_STAR_187579,_STAR_depth_STAR_187580,_STAR_shared_STAR_187581,_STAR_instrument_STAR_187582,_STAR_parent_STAR_187583,this$,this__41158__auto__,x187576_187588))
}))),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "password"}),"Password"),om.dom.input.call(null,({"name": "password", "className": "form-control", "type": "password", "value": password, "onChange": ((function (map__187584,map__187584__$1,username,password,password2,_STAR_reconciler_STAR_187579,_STAR_depth_STAR_187580,_STAR_shared_STAR_187581,_STAR_instrument_STAR_187582,_STAR_parent_STAR_187583,this$,this__41158__auto__,x187576_187588){
return (function (p1__187570_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","password","ui/password",417022099),new cljs.core.Keyword(null,"event","event",301435442),p1__187570_SHARP_);
});})(map__187584,map__187584__$1,username,password,password2,_STAR_reconciler_STAR_187579,_STAR_depth_STAR_187580,_STAR_shared_STAR_187581,_STAR_instrument_STAR_187582,_STAR_parent_STAR_187583,this$,this__41158__auto__,x187576_187588))
}))),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "password2"}),"Verify your Password"),om.dom.input.call(null,({"name": "password2", "className": "form-control", "type": "password", "value": password2, "onChange": ((function (map__187584,map__187584__$1,username,password,password2,_STAR_reconciler_STAR_187579,_STAR_depth_STAR_187580,_STAR_shared_STAR_187581,_STAR_instrument_STAR_187582,_STAR_parent_STAR_187583,this$,this__41158__auto__,x187576_187588){
return (function (p1__187571_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","password2","ui/password2",557832013),new cljs.core.Keyword(null,"event","event",301435442),p1__187571_SHARP_);
});})(map__187584,map__187584__$1,username,password,password2,_STAR_reconciler_STAR_187579,_STAR_depth_STAR_187580,_STAR_shared_STAR_187581,_STAR_instrument_STAR_187582,_STAR_parent_STAR_187583,this$,this__41158__auto__,x187576_187588))
}))),om.dom.button.call(null,({"onClick": ((function (map__187584,map__187584__$1,username,password,password2,_STAR_reconciler_STAR_187579,_STAR_depth_STAR_187580,_STAR_shared_STAR_187581,_STAR_instrument_STAR_187582,_STAR_parent_STAR_187583,this$,this__41158__auto__,x187576_187588){
return (function (){
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_187583;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_187582;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_187581;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_187580;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_187579;
}});})(x187576_187588))
;
...
var x187586_187592 = ebtanas.ui.new_user.NewUser;
/** @nocollapse */
x187586_187592.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x187586_187592.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x187586_187592){
...
/** @nocollapse */
x187586_187592.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x187586_187592.om$next$IQuery$query$arity$1 = ((function (x187586_187592){
...
/** @nocollapse */
x187586_187592.om$next$Ident$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x187586_187592.om$next$Ident$ident$arity$2 = ((function (x187586_187592){
...
var x187587_187593 = ebtanas.ui.new_user.NewUser.prototype;

x187587_187593.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;


x187587_187593.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x187587_187593){
return (function (this$,params){
var this$__$1 = this;
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"new-user","new-user",1575436062),new cljs.core.Keyword("ui","username","ui/username",1605670678),"",new cljs.core.Keyword("ui","password","ui/password",417022099),"",new cljs.core.Keyword("ui","password2","ui/password2",557832013),""], null);
});})(x187587_187593))
...
x187587_187593.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;


x187587_187593.om$next$IQuery$query$arity$1 = ((function (x187587_187593){
return (function (this$){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword("ui","username","ui/username",1605670678),new cljs.core.Keyword("ui","password","ui/password",417022099),new cljs.core.Keyword("ui","password2","ui/password2",557832013)], null);
});})(x187587_187593))
...
x187587_187593.om$next$Ident$ = cljs.core.PROTOCOL_SENTINEL;


x187587_187593.om$next$Ident$ident$arity$2 = ((function (x187587_187593){
return (function (this$,props){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"new-user","new-user",1575436062),new cljs.core.Keyword(null,"page","page",849072397)], null);
});})(x187587_187593))
...
//# sourceMappingURL=new_user.js.map?rel=1491715071132