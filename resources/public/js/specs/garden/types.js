...
garden.types.CSSUnit.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__39883__auto__,k186812,else__39884__auto__){
var self__ = this;
var this__39883__auto____$1 = this;
var G__186814 = (((k186812 instanceof cljs.core.Keyword))?k186812.fqn:null);
switch (G__186814) {
case "unit":
return self__.unit;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k186812,else__39884__auto__);
...
garden.types.CSSUnit.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__39888__auto__,k__39889__auto__,G__186811){
var self__ = this;
var this__39888__auto____$1 = this;
var pred__186815 = cljs.core.keyword_identical_QMARK_;
var expr__186816 = k__39889__auto__;
if(cljs.core.truth_(pred__186815.call(null,new cljs.core.Keyword(null,"unit","unit",375175175),expr__186816))){
return (new garden.types.CSSUnit(G__186811,self__.magnitude,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__186815.call(null,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__186816))){
return (new garden.types.CSSUnit(self__.unit,G__186811,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__39889__auto__,G__186811),null));
}
}
});
...
garden.types.CSSUnit.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__39880__auto__,G__186811){
var self__ = this;
var this__39880__auto____$1 = this;
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,G__186811,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSUnit = (function garden$types$map__GT_CSSUnit(G__186813){
return (new garden.types.CSSUnit(new cljs.core.Keyword(null,"unit","unit",375175175).cljs$core$IFn$_invoke$arity$1(G__186813),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222).cljs$core$IFn$_invoke$arity$1(G__186813),null,cljs.core.dissoc.call(null,G__186813,new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)),null));
});
...
garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__39883__auto__,k186820,else__39884__auto__){
var self__ = this;
var this__39883__auto____$1 = this;
var G__186822 = (((k186820 instanceof cljs.core.Keyword))?k186820.fqn:null);
switch (G__186822) {
case "function":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k186820,else__39884__auto__);
...
garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__186819){
var self__ = this;
var G__186819__$1 = this;
return (new cljs.core.RecordIter((0),G__186819__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"function","function",-2127255473),new cljs.core.Keyword(null,"args","args",1315556576)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__39888__auto__,k__39889__auto__,G__186819){
var self__ = this;
var this__39888__auto____$1 = this;
var pred__186823 = cljs.core.keyword_identical_QMARK_;
var expr__186824 = k__39889__auto__;
if(cljs.core.truth_(pred__186823.call(null,new cljs.core.Keyword(null,"function","function",-2127255473),expr__186824))){
return (new garden.types.CSSFunction(G__186819,self__.args,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__186823.call(null,new cljs.core.Keyword(null,"args","args",1315556576),expr__186824))){
return (new garden.types.CSSFunction(self__.function$,G__186819,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSFunction(self__.function$,self__.args,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__39889__auto__,G__186819),null));
}
}
});
...
garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__39880__auto__,G__186819){
var self__ = this;
var this__39880__auto____$1 = this;
return (new garden.types.CSSFunction(self__.function$,self__.args,G__186819,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSFunction = (function garden$types$map__GT_CSSFunction(G__186821){
return (new garden.types.CSSFunction(new cljs.core.Keyword(null,"function","function",-2127255473).cljs$core$IFn$_invoke$arity$1(G__186821),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__186821),null,cljs.core.dissoc.call(null,G__186821,new cljs.core.Keyword(null,"function","function",-2127255473),new cljs.core.Keyword(null,"args","args",1315556576)),null));
});
...
garden.types.CSSAtRule.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__39883__auto__,k186828,else__39884__auto__){
var self__ = this;
var this__39883__auto____$1 = this;
var G__186830 = (((k186828 instanceof cljs.core.Keyword))?k186828.fqn:null);
switch (G__186830) {
case "identifier":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k186828,else__39884__auto__);
...
garden.types.CSSAtRule.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__39888__auto__,k__39889__auto__,G__186827){
var self__ = this;
var this__39888__auto____$1 = this;
var pred__186831 = cljs.core.keyword_identical_QMARK_;
var expr__186832 = k__39889__auto__;
if(cljs.core.truth_(pred__186831.call(null,new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__186832))){
return (new garden.types.CSSAtRule(G__186827,self__.value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__186831.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__186832))){
return (new garden.types.CSSAtRule(self__.identifier,G__186827,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSAtRule(self__.identifier,self__.value,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__39889__auto__,G__186827),null));
}
}
});
...
garden.types.CSSAtRule.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__39880__auto__,G__186827){
var self__ = this;
var this__39880__auto____$1 = this;
return (new garden.types.CSSAtRule(self__.identifier,self__.value,G__186827,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSAtRule = (function garden$types$map__GT_CSSAtRule(G__186829){
return (new garden.types.CSSAtRule(new cljs.core.Keyword(null,"identifier","identifier",-805503498).cljs$core$IFn$_invoke$arity$1(G__186829),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__186829),null,cljs.core.dissoc.call(null,G__186829,new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)),null));
});


//# sourceMappingURL=types.js.map?rel=1491715068651