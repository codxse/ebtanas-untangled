...
garden.types.CSSUnit.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35232__auto__,k53864,else__35233__auto__){
var self__ = this;
var this__35232__auto____$1 = this;
var G__53866 = (((k53864 instanceof cljs.core.Keyword))?k53864.fqn:null);
switch (G__53866) {
case "unit":
return self__.unit;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k53864,else__35233__auto__);
...
garden.types.CSSUnit.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__53863){
var self__ = this;
var G__53863__$1 = this;
return (new cljs.core.RecordIter((0),G__53863__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
garden.types.CSSUnit.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35237__auto__,k__35238__auto__,G__53863){
var self__ = this;
var this__35237__auto____$1 = this;
var pred__53867 = cljs.core.keyword_identical_QMARK_;
var expr__53868 = k__35238__auto__;
if(cljs.core.truth_(pred__53867.call(null,new cljs.core.Keyword(null,"unit","unit",375175175),expr__53868))){
return (new garden.types.CSSUnit(G__53863,self__.magnitude,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__53867.call(null,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__53868))){
return (new garden.types.CSSUnit(self__.unit,G__53863,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35238__auto__,G__53863),null));
}
}
});
...
garden.types.CSSUnit.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35229__auto__,G__53863){
var self__ = this;
var this__35229__auto____$1 = this;
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,G__53863,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSUnit = (function garden$types$map__GT_CSSUnit(G__53865){
return (new garden.types.CSSUnit(new cljs.core.Keyword(null,"unit","unit",375175175).cljs$core$IFn$_invoke$arity$1(G__53865),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222).cljs$core$IFn$_invoke$arity$1(G__53865),null,cljs.core.dissoc.call(null,G__53865,new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)),null));
});
...
garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35232__auto__,k53872,else__35233__auto__){
var self__ = this;
var this__35232__auto____$1 = this;
var G__53874 = (((k53872 instanceof cljs.core.Keyword))?k53872.fqn:null);
switch (G__53874) {
case "function":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k53872,else__35233__auto__);
...
garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__53871){
var self__ = this;
var G__53871__$1 = this;
return (new cljs.core.RecordIter((0),G__53871__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"function","function",-2127255473),new cljs.core.Keyword(null,"args","args",1315556576)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35237__auto__,k__35238__auto__,G__53871){
var self__ = this;
var this__35237__auto____$1 = this;
var pred__53875 = cljs.core.keyword_identical_QMARK_;
var expr__53876 = k__35238__auto__;
if(cljs.core.truth_(pred__53875.call(null,new cljs.core.Keyword(null,"function","function",-2127255473),expr__53876))){
return (new garden.types.CSSFunction(G__53871,self__.args,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__53875.call(null,new cljs.core.Keyword(null,"args","args",1315556576),expr__53876))){
return (new garden.types.CSSFunction(self__.function$,G__53871,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSFunction(self__.function$,self__.args,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35238__auto__,G__53871),null));
}
}
});
...
garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35229__auto__,G__53871){
var self__ = this;
var this__35229__auto____$1 = this;
return (new garden.types.CSSFunction(self__.function$,self__.args,G__53871,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSFunction = (function garden$types$map__GT_CSSFunction(G__53873){
return (new garden.types.CSSFunction(new cljs.core.Keyword(null,"function","function",-2127255473).cljs$core$IFn$_invoke$arity$1(G__53873),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__53873),null,cljs.core.dissoc.call(null,G__53873,new cljs.core.Keyword(null,"function","function",-2127255473),new cljs.core.Keyword(null,"args","args",1315556576)),null));
});
...
garden.types.CSSAtRule.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35232__auto__,k53880,else__35233__auto__){
var self__ = this;
var this__35232__auto____$1 = this;
var G__53882 = (((k53880 instanceof cljs.core.Keyword))?k53880.fqn:null);
switch (G__53882) {
case "identifier":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k53880,else__35233__auto__);
...
garden.types.CSSAtRule.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__53879){
var self__ = this;
var G__53879__$1 = this;
return (new cljs.core.RecordIter((0),G__53879__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
garden.types.CSSAtRule.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35237__auto__,k__35238__auto__,G__53879){
var self__ = this;
var this__35237__auto____$1 = this;
var pred__53883 = cljs.core.keyword_identical_QMARK_;
var expr__53884 = k__35238__auto__;
if(cljs.core.truth_(pred__53883.call(null,new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__53884))){
return (new garden.types.CSSAtRule(G__53879,self__.value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__53883.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__53884))){
return (new garden.types.CSSAtRule(self__.identifier,G__53879,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSAtRule(self__.identifier,self__.value,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35238__auto__,G__53879),null));
}
}
});
...
garden.types.CSSAtRule.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35229__auto__,G__53879){
var self__ = this;
var this__35229__auto____$1 = this;
return (new garden.types.CSSAtRule(self__.identifier,self__.value,G__53879,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSAtRule = (function garden$types$map__GT_CSSAtRule(G__53881){
return (new garden.types.CSSAtRule(new cljs.core.Keyword(null,"identifier","identifier",-805503498).cljs$core$IFn$_invoke$arity$1(G__53881),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__53881),null,cljs.core.dissoc.call(null,G__53881,new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)),null));
});


//# sourceMappingURL=types.js.map?rel=1491640769419