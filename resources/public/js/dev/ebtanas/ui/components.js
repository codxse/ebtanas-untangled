...
var x228882_228894 = ebtanas.ui.components.PlaceholderImage.prototype;
x228882_228894.componentWillUpdate = ((function (x228882_228894){
...
var ident__41163__auto___228895 = om.next.ident.call(null,this__41159__auto__,om.next.props.call(null,this__41159__auto__));
var next_ident__41164__auto___228896 = om.next.ident.call(null,this__41159__auto__,om.next._next_props.call(null,next_props__41160__auto__,this__41159__auto__));
if(cljs.core.not_EQ_.call(null,ident__41163__auto___228895,next_ident__41164__auto___228896)){
var idxr__41165__auto___228897 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__41159__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__41165__auto___228897 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__41165__auto___228897),((function (idxr__41165__auto___228897,ident__41163__auto___228895,next_ident__41164__auto___228896,this__41159__auto__,x228882_228894){
return (function (indexes__41166__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__41166__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__41163__auto___228895], null),cljs.core.disj,this__41159__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__41164__auto___228896], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__41159__auto__);
});})(idxr__41165__auto___228897,ident__41163__auto___228895,next_ident__41164__auto___228896,this__41159__auto__,x228882_228894))
);
}
} else {
}
...
x228882_228894.shouldComponentUpdate = ((function (x228882_228894){
return (function (next_props__41160__auto__,next_state__41161__auto__){
var this__41159__auto__ = this;
...
var next_props__41160__auto____$2 = (function (){var G__228884 = next_props__41160__auto____$1;
if((next_props__41160__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__228884);
} else {
return G__228884;
}
})();
...
x228882_228894.componentWillUnmount = ((function (x228882_228894){
return (function (){
var this__41159__auto__ = this;
...
x228882_228894.componentDidUpdate = ((function (x228882_228894){
...
x228882_228894.isMounted = ((function (x228882_228894){
return (function (){
var this__41159__auto__ = this;
...
x228882_228894.componentWillMount = ((function (x228882_228894){
return (function (){
var this__41159__auto__ = this;
...
x228882_228894.render = ((function (x228882_228894){
return (function (){
var this__41158__auto__ = this;
var this$ = this__41158__auto__;
var _STAR_reconciler_STAR_228885 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_228886 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_228887 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_228888 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_228889 = om.next._STAR_parent_STAR_;
...
try{var map__228890 = om.next.props.call(null,this$);
var map__228890__$1 = ((((!((map__228890 == null)))?((((map__228890.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__228890.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__228890):map__228890);
var w = cljs.core.get.call(null,map__228890__$1,new cljs.core.Keyword(null,"w","w",354169001));
var h = cljs.core.get.call(null,map__228890__$1,new cljs.core.Keyword(null,"h","h",1109658740));
var label = cljs.core.get.call(null,map__228890__$1,new cljs.core.Keyword(null,"label","label",1718410804));
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_228889;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_228888;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_228887;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_228886;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_228885;
}});})(x228882_228894))
;
...
var x228892_228898 = ebtanas.ui.components.PlaceholderImage;


var x228893_228899 = ebtanas.ui.components.PlaceholderImage.prototype;
...
//# sourceMappingURL=components.js.map?rel=1491715148627