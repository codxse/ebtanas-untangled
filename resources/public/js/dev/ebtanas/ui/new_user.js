...
var x105407_105419 = ebtanas.ui.new_user.NewUser.prototype;
x105407_105419.componentWillUpdate = ((function (x105407_105419){
...
var ident__42890__auto___105420 = om.next.ident.call(null,this__42886__auto__,om.next.props.call(null,this__42886__auto__));
var next_ident__42891__auto___105421 = om.next.ident.call(null,this__42886__auto__,om.next._next_props.call(null,next_props__42887__auto__,this__42886__auto__));
if(cljs.core.not_EQ_.call(null,ident__42890__auto___105420,next_ident__42891__auto___105421)){
var idxr__42892__auto___105422 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__42886__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__42892__auto___105422 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__42892__auto___105422),((function (idxr__42892__auto___105422,ident__42890__auto___105420,next_ident__42891__auto___105421,this__42886__auto__,x105407_105419){
return (function (indexes__42893__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__42893__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__42890__auto___105420], null),cljs.core.disj,this__42886__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__42891__auto___105421], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__42886__auto__);
});})(idxr__42892__auto___105422,ident__42890__auto___105420,next_ident__42891__auto___105421,this__42886__auto__,x105407_105419))
);
}
} else {
}
...
x105407_105419.shouldComponentUpdate = ((function (x105407_105419){
return (function (next_props__42887__auto__,next_state__42888__auto__){
var this__42886__auto__ = this;
...
var next_props__42887__auto____$2 = (function (){var G__105409 = next_props__42887__auto____$1;
if((next_props__42887__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__105409);
} else {
return G__105409;
}
})();
...
x105407_105419.componentWillUnmount = ((function (x105407_105419){
return (function (){
var this__42886__auto__ = this;
...
x105407_105419.componentDidUpdate = ((function (x105407_105419){
...
x105407_105419.isMounted = ((function (x105407_105419){
return (function (){
var this__42886__auto__ = this;
...
x105407_105419.componentWillMount = ((function (x105407_105419){
return (function (){
var this__42886__auto__ = this;
...
x105407_105419.render = ((function (x105407_105419){
return (function (){
var this__42885__auto__ = this;
var this$ = this__42885__auto__;
var _STAR_reconciler_STAR_105410 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_105411 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_105412 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_105413 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_105414 = om.next._STAR_parent_STAR_;
...
try{var map__105415 = om.next.props.call(null,this$);
var map__105415__$1 = ((((!((map__105415 == null)))?((((map__105415.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__105415.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__105415):map__105415);
var username = cljs.core.get.call(null,map__105415__$1,new cljs.core.Keyword("ui","username","ui/username",1605670678));
var password = cljs.core.get.call(null,map__105415__$1,new cljs.core.Keyword("ui","password","ui/password",417022099));
var password2 = cljs.core.get.call(null,map__105415__$1,new cljs.core.Keyword("ui","password2","ui/password2",557832013));
return om.dom.div.call(null,null,om.dom.div.call(null,({"className": "row"}),om.dom.div.call(null,({"className": "col-xs-4"}),""),om.dom.div.call(null,cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"className","className",-1983287057),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(om_css.core.local_class.call(null,ebtanas.ui.new_user.NewUser,"form")),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.str.cljs$core$IFn$_invoke$arity$1("col-xs-4"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" ")].join('')], null)),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "username"}),"Email Address"),om.dom.input.call(null,({"className": "form-control", "type": "email", "name": "username", "value": username, "onChange": ((function (map__105415,map__105415__$1,username,password,password2,_STAR_reconciler_STAR_105410,_STAR_depth_STAR_105411,_STAR_shared_STAR_105412,_STAR_instrument_STAR_105413,_STAR_parent_STAR_105414,this$,this__42885__auto__,x105407_105419){
return (function (p1__105400_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","username","ui/username",1605670678),new cljs.core.Keyword(null,"event","event",301435442),p1__105400_SHARP_);
});})(map__105415,map__105415__$1,username,password,password2,_STAR_reconciler_STAR_105410,_STAR_depth_STAR_105411,_STAR_shared_STAR_105412,_STAR_instrument_STAR_105413,_STAR_parent_STAR_105414,this$,this__42885__auto__,x105407_105419))
}))),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "password"}),"Password"),om.dom.input.call(null,({"name": "password", "className": "form-control", "type": "password", "value": password, "onChange": ((function (map__105415,map__105415__$1,username,password,password2,_STAR_reconciler_STAR_105410,_STAR_depth_STAR_105411,_STAR_shared_STAR_105412,_STAR_instrument_STAR_105413,_STAR_parent_STAR_105414,this$,this__42885__auto__,x105407_105419){
return (function (p1__105401_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","password","ui/password",417022099),new cljs.core.Keyword(null,"event","event",301435442),p1__105401_SHARP_);
});})(map__105415,map__105415__$1,username,password,password2,_STAR_reconciler_STAR_105410,_STAR_depth_STAR_105411,_STAR_shared_STAR_105412,_STAR_instrument_STAR_105413,_STAR_parent_STAR_105414,this$,this__42885__auto__,x105407_105419))
}))),om.dom.div.call(null,({"className": "form-group"}),om.dom.label.call(null,({"htmlFor": "password2"}),"Verify your Password"),om.dom.input.call(null,({"name": "password2", "className": "form-control", "type": "password", "value": password2, "onChange": ((function (map__105415,map__105415__$1,username,password,password2,_STAR_reconciler_STAR_105410,_STAR_depth_STAR_105411,_STAR_shared_STAR_105412,_STAR_instrument_STAR_105413,_STAR_parent_STAR_105414,this$,this__42885__auto__,x105407_105419){
return (function (p1__105402_SHARP_){
return untangled.client.mutations.set_string_BANG_.call(null,this$,new cljs.core.Keyword("ui","password2","ui/password2",557832013),new cljs.core.Keyword(null,"event","event",301435442),p1__105402_SHARP_);
});})(map__105415,map__105415__$1,username,password,password2,_STAR_reconciler_STAR_105410,_STAR_depth_STAR_105411,_STAR_shared_STAR_105412,_STAR_instrument_STAR_105413,_STAR_parent_STAR_105414,this$,this__42885__auto__,x105407_105419))
}))),om.dom.button.call(null,({"onClick": ((function (map__105415,map__105415__$1,username,password,password2,_STAR_reconciler_STAR_105410,_STAR_depth_STAR_105411,_STAR_shared_STAR_105412,_STAR_instrument_STAR_105413,_STAR_parent_STAR_105414,this$,this__42885__auto__,x105407_105419){
return (function (){
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_105414;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_105413;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_105412;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_105411;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_105410;
}});})(x105407_105419))
;
...
var x105417_105423 = ebtanas.ui.new_user.NewUser;
/** @nocollapse */
x105417_105423.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x105417_105423.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x105417_105423){
...
/** @nocollapse */
x105417_105423.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x105417_105423.om$next$IQuery$query$arity$1 = ((function (x105417_105423){
...
/** @nocollapse */
x105417_105423.om$next$Ident$ = cljs.core.PROTOCOL_SENTINEL;

/** @nocollapse */
x105417_105423.om$next$Ident$ident$arity$2 = ((function (x105417_105423){
...
var x105418_105424 = ebtanas.ui.new_user.NewUser.prototype;

x105418_105424.untangled$client$core$InitialAppState$ = cljs.core.PROTOCOL_SENTINEL;


x105418_105424.untangled$client$core$InitialAppState$initial_state$arity$2 = ((function (x105418_105424){
return (function (this$,params){
var this$__$1 = this;
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"new-user","new-user",1575436062),new cljs.core.Keyword("ui","username","ui/username",1605670678),"",new cljs.core.Keyword("ui","password","ui/password",417022099),"",new cljs.core.Keyword("ui","password2","ui/password2",557832013),""], null);
});})(x105418_105424))
...
x105418_105424.om$next$IQuery$ = cljs.core.PROTOCOL_SENTINEL;


x105418_105424.om$next$IQuery$query$arity$1 = ((function (x105418_105424){
return (function (this$){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword("ui","username","ui/username",1605670678),new cljs.core.Keyword("ui","password","ui/password",417022099),new cljs.core.Keyword("ui","password2","ui/password2",557832013)], null);
});})(x105418_105424))
...
x105418_105424.om$next$Ident$ = cljs.core.PROTOCOL_SENTINEL;


x105418_105424.om$next$Ident$ident$arity$2 = ((function (x105418_105424){
return (function (this$,props){
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"new-user","new-user",1575436062),new cljs.core.Keyword(null,"page","page",849072397)], null);
});})(x105418_105424))
...
//# sourceMappingURL=new_user.js.map?rel=1491640859195