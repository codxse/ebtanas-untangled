...
var temp__6753__auto____$1 = goog.object.get(o__77923__auto__,"core");
if(cljs.core.truth_(temp__6753__auto____$1)){
var o__77922__auto__ = temp__6753__auto____$1;
return goog.object.get(o__77922__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__77910__auto__ = f;
return goog.object.get(o__77910__auto__,"toString").call(o__77910__auto__);
}catch (e230965){var _ = e230965;
return "";
}});
...
try{var o__77910__auto___230968 = t;
goog.object.get(o__77910__auto___230968,"cljs$lang$ctorPrWriter").call(o__77910__auto___230968,t,writer);
}catch (e230967){var __230969 = e230967;
}
...
var char_code = (function (){var o__77910__auto__ = (new String(char$));
return goog.object.get(o__77910__auto__,"charCodeAt").call(o__77910__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__77910__auto__ = String;
return goog.object.get(o__77910__auto__,"fromCharCode").call(o__77910__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__230971 = num_code;
switch (G__230971) {
case (1):
return (185);
...
var o__77910__auto__ = String;
return goog.object.get(o__77910__auto__,"fromCharCode").call(o__77910__auto__,superscript_code);
});
/**
...
}catch (e230977){var e__77935__auto__ = e230977;
return false;
}})())){
...
var vec__230978 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__230978,(0),null);
...
var or__39206__auto__ = (function (){var temp__6751__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__6751__auto__)){
...
if(cljs.core.truth_(temp__6753__auto__)){
var o__77923__auto__ = temp__6753__auto__;
var temp__6753__auto____$1 = goog.object.get(o__77923__auto__,"dependencies_");
if(cljs.core.truth_(temp__6753__auto____$1)){
var o__77922__auto__ = temp__6753__auto____$1;
return goog.object.get(o__77922__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__40427__auto___230987 = arguments.length;
var i__40428__auto___230988 = (0);
while(true){
if((i__40428__auto___230988 < len__40427__auto___230987)){
args__40434__auto__.push((arguments[i__40428__auto___230988]));

var G__230989 = (i__40428__auto___230988 + (1));
i__40428__auto___230988 = G__230989;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__40435__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__230983){
var vec__230984 = p__230983;
var ns_detector = cljs.core.nth.call(null,vec__230984,(0),null);
var effective_detector = (function (){var or__39206__auto__ = ns_detector;
if(cljs.core.truth_(or__39206__auto__)){
return or__39206__auto__;
} else {
...
var G__230990 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__230991 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__230990;
remaining_tokens = G__230991;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq230981){
var G__230982 = cljs.core.first.call(null,seq230981);
var seq230981__$1 = cljs.core.next.call(null,seq230981);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__230982,seq230981__$1);
});
...
var vec__230999 = cljs.core.split_with.call(null,(function (p1__230995_SHARP_){
return cljs.core.not_EQ_.call(null,p1__230995_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__230999,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__230999,(1),null);
...
var vec__231005 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__231005,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__231005,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__231008 = cljs.core.rest.call(null,remaining_tokens);
var G__231009 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__231008;
name_tokens = G__231009;
continue;
} else {
...
var args231010 = [];
var len__40427__auto___231022 = arguments.length;
var i__40428__auto___231023 = (0);
while(true){
if((i__40428__auto___231023 < len__40427__auto___231022)){
args231010.push((arguments[i__40428__auto___231023]));

var G__231024 = (i__40428__auto___231023 + (1));
i__40428__auto___231023 = G__231024;
continue;
} else {
}
break;
...
var G__231012 = args231010.length;
switch (G__231012) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args231010.length)].join('')));
...
var vec__231013 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__231013,(0),null);
var arity = cljs.core.nth.call(null,vec__231013,(1),null);
var vec__231016 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__231016,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__231016,(1),null);
var vec__231019 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__231019,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__231019,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__231019,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__231019,(3),null);
...
var args231026 = [];
var len__40427__auto___231032 = arguments.length;
var i__40428__auto___231033 = (0);
while(true){
if((i__40428__auto___231033 < len__40427__auto___231032)){
args231026.push((arguments[i__40428__auto___231033]));

var G__231034 = (i__40428__auto___231033 + (1));
i__40428__auto___231033 = G__231034;
continue;
} else {
}
break;
...
var G__231028 = args231026.length;
switch (G__231028) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args231026.length)].join('')));
...
var vec__231029 = result;
var munged_ns = cljs.core.nth.call(null,vec__231029,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__231029,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__231029,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__231029,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__231029,(4),null);
var arity = cljs.core.nth.call(null,vec__231029,(5),null);
...
if(cljs.core.truth_(temp__6751__auto__)){
var vec__231042 = temp__6751__auto__;
var munged_name = cljs.core.nth.call(null,vec__231042,(0),null);
var args = cljs.core.nth.call(null,vec__231042,(1),null);
var vec__231045 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__231045,(0),null);
var name = cljs.core.nth.call(null,vec__231045,(1),null);
...
var G__231048 = (arity + (1));
var G__231049 = (function (){var temp__6751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__231050){
var vec__231054 = p__231050;
var arity = cljs.core.nth.call(null,vec__231054,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__231054,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__39206__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__39206__auto__)){
return or__39206__auto__;
} else {
...
return (function (p1__231057_SHARP_){
return cljs.core.get.call(null,arities,p1__231057_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__231058_SHARP_){
return cljs.core.drop.call(null,(2),p1__231058_SHARP_);
...
var args__40434__auto__ = [];
var len__40427__auto___231065 = arguments.length;
var i__40428__auto___231066 = (0);
while(true){
if((i__40428__auto___231066 < len__40427__auto___231065)){
args__40434__auto__.push((arguments[i__40428__auto___231066]));

var G__231067 = (i__40428__auto___231066 + (1));
i__40428__auto___231066 = G__231067;
continue;
} else {
}
break;
...
var argseq__40435__auto__ = ((((1) < args__40434__auto__.length))?(new cljs.core.IndexedSeq(args__40434__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__40435__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__231061){
var vec__231062 = p__231061;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__231062,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq231059){
var G__231060 = cljs.core.first.call(null,seq231059);
var seq231059__$1 = cljs.core.next.call(null,seq231059);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__231060,seq231059__$1);
});
...
var G__231069 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__231069) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__39206__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__39206__auto__)){
return or__39206__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__39194__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__39206__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__39206__auto__)){
return or__39206__auto__;
} else {
...
var map__231076 = options;
var map__231076__$1 = ((((!((map__231076 == null)))?((((map__231076.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__231076.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__231076):map__231076);
var include_ns_QMARK_ = cljs.core.get.call(null,map__231076__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__231076__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__231076__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__231076__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__231077 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__231077,(0),null);
var fn_name = cljs.core.nth.call(null,vec__231077,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__231077,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__231077,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__231077,(4),null);
var arity = cljs.core.nth.call(null,vec__231077,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__39194__auto__ = protocol_ns;
if(cljs.core.truth_(and__39194__auto__)){
return cljs.core.not.call(null,(function (){var and__39194__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__39206__auto__ = protocol_part;
if(cljs.core.truth_(or__39206__auto__)){
return or__39206__auto__;
} else {
return fn_part;
...
var o__77910__auto__ = f;
return goog.object.get(o__77910__auto__,"getBasis").call(o__77910__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__39194__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__39194__auto__)){
...
}catch (e231082){var e__77935__auto__ = e231082;
...
var G__231083 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__231084 = cljs.core.rest.call(null,path);
obj = G__231083;
path = G__231084;
continue;
} else {
...
var partition_bits = (function (){var or__39206__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__39206__auto__)){
return or__39206__auto__;
} else {
return (0);
...
return (function (accum,p__231089){
var vec__231090 = p__231089;
var bit = cljs.core.nth.call(null,vec__231090,(0),null);
var protocol = cljs.core.nth.call(null,vec__231090,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__231093){
var vec__231097 = p__231093;
var ns = cljs.core.nth.call(null,vec__231097,(0),null);
var name = cljs.core.nth.call(null,vec__231097,(1),null);
var selector = cljs.core.nth.call(null,vec__231097,(2),null);
...
return (function (p__231105){
var vec__231106 = p__231105;
var munged_name = cljs.core.nth.call(null,vec__231106,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__231106,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__231106,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__231100_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__231100_SHARP_));
});})(name,sorted_matches,vec__231106,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1491715154570