...
var G__110155 = devtools.prefs.pref.call(null,v);
v = G__110155;
continue;
} else {
return v;
...
var and__34543__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__34543__auto__){
var and__34543__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__34555__auto__ = (function (){try{if(!((value == null))){
...
}catch (e110168){var e__67769__auto__ = e110168;
return false;
}})();
if(cljs.core.truth_(or__34555__auto__)){
return or__34555__auto__;
} else {
var or__34555__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e110172){var e__67769__auto__ = e110172;
return false;
}})();
...
}catch (e110174){var e__67769__auto__ = e110174;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__34543__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__34543__auto__)){
var and__34543__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__34543__auto____$1){
...
var and__34543__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__34543__auto__)){
...
var or__34555__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__34555__auto__)){
return or__34555__auto__;
} else {
...
var and__34543__auto__ = (function (){var or__34555__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__34555__auto__)){
return or__34555__auto__;
} else {
...
var vec__110179 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__110179,(0),null);
var name = cljs.core.nth.call(null,vec__110179,(1),null);
...
var and__34543__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__34543__auto__)){
...
var or__34555__auto__ = typeof value === 'string';
if(or__34555__auto__){
return or__34555__auto__;
} else {
var or__34555__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__110182_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__110182_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1491640864667