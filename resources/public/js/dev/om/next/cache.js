...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__94149 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__94150 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__94150,x_SINGLEQUOTE__94149,this$){
return (function (p1__94148_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__94148_SHARP_,id_SINGLEQUOTE__94150),id,x_SINGLEQUOTE__94149);
});})(id_SINGLEQUOTE__94150,x_SINGLEQUOTE__94149,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__94149);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__35212__auto__,writer__35213__auto__,opt__35214__auto__){
return cljs.core._write.call(null,writer__35213__auto__,"om.next.cache/Cache");
});
...
//# sourceMappingURL=cache.js.map?rel=1491640833297