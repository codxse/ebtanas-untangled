...
var args99429 = [];
var len__35776__auto___99433 = arguments.length;
var i__35777__auto___99434 = (0);
while(true){
if((i__35777__auto___99434 < len__35776__auto___99433)){
args99429.push((arguments[i__35777__auto___99434]));

var G__99435 = (i__35777__auto___99434 + (1));
i__35777__auto___99434 = G__99435;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args99429.length)].join('')));
...
}catch (e99432){if((e99432 instanceof Object)){
var e = e99432;
...
untangled.client.impl.network.Network.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35232__auto__,k99438,else__35233__auto__){
var self__ = this;
var this__35232__auto____$1 = this;
var G__99440 = (((k99438 instanceof cljs.core.Keyword))?k99438.fqn:null);
switch (G__99440) {
case "url":
return self__.url;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k99438,else__35233__auto__);
...
untangled.client.impl.network.Network.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__99437){
var self__ = this;
var G__99437__$1 = this;
return (new cljs.core.RecordIter((0),G__99437__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
var map__99441 = (function (){var G__99442 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"body","body",-2049205669),edn,new cljs.core.Keyword(null,"headers","headers",-835030129),headers], null);
if(cljs.core.truth_(self__.request_transform)){
return self__.request_transform.call(null,G__99442);
} else {
return G__99442;
}
})();
var map__99441__$1 = ((((!((map__99441 == null)))?((((map__99441.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__99441.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__99441):map__99441);
var body = cljs.core.get.call(null,map__99441__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var headers__$1 = cljs.core.get.call(null,map__99441__$1,new cljs.core.Keyword(null,"headers","headers",-835030129));
...
goog.events.listen(xhrio,goog.net.EventType.SUCCESS,((function (xhrio,handlers,headers,map__99441,map__99441__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
return untangled.client.impl.network.response_ok.call(null,this$__$1,xhrio,ok);
});})(xhrio,handlers,headers,map__99441,map__99441__$1,body,headers__$1,post_data,headers__$2,this$__$1))
);

return goog.events.listen(xhrio,goog.net.EventType.ERROR,((function (xhrio,handlers,headers,map__99441,map__99441__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
...
untangled.client.impl.network.Network.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35237__auto__,k__35238__auto__,G__99437){
var self__ = this;
var this__35237__auto____$1 = this;
var pred__99444 = cljs.core.keyword_identical_QMARK_;
var expr__99445 = k__35238__auto__;
if(cljs.core.truth_(pred__99444.call(null,new cljs.core.Keyword(null,"url","url",276297046),expr__99445))){
return (new untangled.client.impl.network.Network(G__99437,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__99444.call(null,new cljs.core.Keyword(null,"request-transform","request-transform",170337297),expr__99445))){
return (new untangled.client.impl.network.Network(self__.url,G__99437,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__99444.call(null,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),expr__99445))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,G__99437,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__99444.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__99445))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,G__99437,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__99444.call(null,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791),expr__99445))){
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,G__99437,self__.__meta,self__.__extmap,null));
} else {
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35238__auto__,G__99437),null));
}
}
}
}
...
untangled.client.impl.network.Network.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35229__auto__,G__99437){
var self__ = this;
var this__35229__auto____$1 = this;
return (new untangled.client.impl.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,G__99437,self__.__extmap,self__.__hash));
});
...
untangled.client.impl.network.map__GT_Network = (function untangled$client$impl$network$map__GT_Network(G__99439){
return (new untangled.client.impl.network.Network(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(G__99439),new cljs.core.Keyword(null,"request-transform","request-transform",170337297).cljs$core$IFn$_invoke$arity$1(G__99439),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631).cljs$core$IFn$_invoke$arity$1(G__99439),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__99439),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791).cljs$core$IFn$_invoke$arity$1(G__99439),null,cljs.core.dissoc.call(null,G__99439,new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)),null));
});
...
var len__35776__auto___99453 = arguments.length;
var i__35777__auto___99454 = (0);
while(true){
if((i__35777__auto___99454 < len__35776__auto___99453)){
args__35783__auto__.push((arguments[i__35777__auto___99454]));

var G__99455 = (i__35777__auto___99454 + (1));
i__35777__auto___99454 = G__99455;
continue;
} else {
}
break;
...
untangled.client.impl.network.make_untangled_network.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__99450){
var map__99451 = p__99450;
var map__99451__$1 = ((((!((map__99451 == null)))?((((map__99451.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__99451.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__99451):map__99451);
var request_transform = cljs.core.get.call(null,map__99451__$1,new cljs.core.Keyword(null,"request-transform","request-transform",170337297));
var global_error_callback = cljs.core.get.call(null,map__99451__$1,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631));
var transit_handlers = cljs.core.get.call(null,map__99451__$1,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791));
...
untangled.client.impl.network.make_untangled_network.cljs$lang$applyTo = (function (seq99448){
var G__99449 = cljs.core.first.call(null,seq99448);
var seq99448__$1 = cljs.core.next.call(null,seq99448);
return untangled.client.impl.network.make_untangled_network.cljs$core$IFn$_invoke$arity$variadic(G__99449,seq99448__$1);
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35232__auto__,k99457,else__35233__auto__){
var self__ = this;
var this__35232__auto____$1 = this;
var G__99459 = (((k99457 instanceof cljs.core.Keyword))?k99457.fqn:null);
switch (G__99459) {
case "complete-app":
return self__.complete_app;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k99457,else__35233__auto__);
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__99456){
var self__ = this;
var G__99456__$1 = this;
return (new cljs.core.RecordIter((0),G__99456__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35237__auto__,k__35238__auto__,G__99456){
var self__ = this;
var this__35237__auto____$1 = this;
var pred__99460 = cljs.core.keyword_identical_QMARK_;
var expr__99461 = k__35238__auto__;
if(cljs.core.truth_(pred__99460.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__99461))){
return (new untangled.client.impl.network.MockNetwork(G__99456,self__.__meta,self__.__extmap,null));
} else {
return (new untangled.client.impl.network.MockNetwork(self__.complete_app,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35238__auto__,G__99456),null));
}
});
...
untangled.client.impl.network.MockNetwork.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35229__auto__,G__99456){
var self__ = this;
var this__35229__auto____$1 = this;
return (new untangled.client.impl.network.MockNetwork(self__.complete_app,G__99456,self__.__extmap,self__.__hash));
});
...
untangled.client.impl.network.map__GT_MockNetwork = (function untangled$client$impl$network$map__GT_MockNetwork(G__99458){
return (new untangled.client.impl.network.MockNetwork(new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__99458),null,cljs.core.dissoc.call(null,G__99458,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)),null));
});
...
//# sourceMappingURL=network.js.map?rel=1491640849077