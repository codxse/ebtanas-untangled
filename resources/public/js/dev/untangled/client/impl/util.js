...
var len__35776__auto___100553 = arguments.length;
var i__35777__auto___100554 = (0);
while(true){
if((i__35777__auto___100554 < len__35776__auto___100553)){
args__35783__auto__.push((arguments[i__35777__auto___100554]));

var G__100555 = (i__35777__auto___100554 + (1));
i__35777__auto___100554 = G__100555;
continue;
} else {
}
break;
...
untangled.client.impl.util.deep_merge.cljs$lang$applyTo = (function (seq100552){
return untangled.client.impl.util.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq100552));
});
...
var args__35783__auto__ = [];
var len__35776__auto___100562 = arguments.length;
var i__35777__auto___100563 = (0);
while(true){
if((i__35777__auto___100563 < len__35776__auto___100562)){
args__35783__auto__.push((arguments[i__35777__auto___100563]));

var G__100564 = (i__35777__auto___100563 + (1));
i__35777__auto___100563 = G__100564;
continue;
} else {
}
break;
...
;
var pred__100559 = cljs.core._EQ_;
var expr__100560 = cljs.core.count.call(null,keys_and_paths);
if(cljs.core.truth_(pred__100559.call(null,(0),expr__100560))){
return cljs.core.deref.call(null,app_state);
} else {
if(cljs.core.truth_(pred__100559.call(null,(1),expr__100560))){
...
}catch (e100558){if((e100558 instanceof Error)){
var e = e100558;
...
untangled.client.impl.util.log_app_state.cljs$lang$applyTo = (function (seq100556){
var G__100557 = cljs.core.first.call(null,seq100556);
var seq100556__$1 = cljs.core.next.call(null,seq100556);
return untangled.client.impl.util.log_app_state.cljs$core$IFn$_invoke$arity$variadic(G__100557,seq100556__$1);
});


//# sourceMappingURL=util.js.map?rel=1491640850755